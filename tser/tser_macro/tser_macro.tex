...
kullanýyor. Butun bir sene icinde bu lira uc kere harcanmis oluyor. 
...
servislerin fiyatý ise $P$ olsun. PMT için gerekli deðiþkenler bunlar. 
...
``yavaþtýr'', kimisi habire alýþveriþtedir, onlarýn parasý hýzlýdýr, biz
tüm paralarýn hýz averajý üzerinden bir $V$ alabiliriz. $P$ tüm ürün ve
servislerin fiyat seviyesi, bu da tabii ki bir ortalama. Son olarak $Y$,
ekonomide satýlan tüm ürün ve servislerin miktarý. Yani $Y$ Reel Gayrisafi
Yurtiçi Hasýla (GSYH) (Ýngilizce GDP) onun fiyat seviyesi ile çarpýlmýþ
hali Nominal GYSH, yani bu ekonominin ürettiði ürünlerin tüm miktarý. Bu
formülün bir tarafý.
...
Bu formüle bir teori bile denemez, gayet bariz bir eþitliktir
...
taným itibariyle doðru olmalýdýr.


Tabii üstteki formüldeki deðiþkenlerin nasýl ölçülmesi gerektiðiyle ilgili
tartýþmalar, farklý yaklaþýmlar olabilir. Mesela kredi kartlarý para olarak
$M$ içinde sayýlmalý mý [evet]. Bu farklýlýklar bir tarafa, üstteki formül
bir eþitlik olarak, ekonomi hakkýndaki fikirlerimizi organize etmesi
açýsýndan çok faydalýdýr. Mesela enflasyonun ($P$'nin yükselmesi) sebebi
nedir sorusunu formül üzerinden cevaplayabiliriz.
