...
df = df.head(1000)
df['AAPL'].plot()
plt.savefig('stat_preproc_01.png')
\end{minted}
...
plt.savefig('stat_preproc_02.png')
\end{minted}
...
Merkez Bankalarýna yardýmcý olan araçlardan biri Taylor Kuralý; bu kural, yani
formül, olmasý gereken Merkez Bankasý faiz oraný, mevcut enflasyon $\pi$, hedef
enflasyon $\pi^*$, ideal faiz oraný $r^*$ ve reel ve potansiyel olduðu safi milli
hasýla farký arasýnda bir iliþki kurar. 
