...
bir ay önce, 18 Eylül) senet fiyatlarýna bakýyoruz, GOOG \$586.08 seviyesinde,
bu da $S$. Risksiz faiz için 4 haftalýk tahvil faizlerine bakabiliriz, ki o da
þu anda \%0.02 seviyesinde. Bu verilerle
...
Ne yazýk ki B-S denklemini cebirsel olarak tekrar düzenleyip $\sigma$'yi
...
yöntemini {\em Diferansiyel Denklemler, Kök Bulmak, Karesel Formül} yazýsýndan
gördük. 

\begin{minted}[fontsize=\footnotesize]{python}
from scipy.stats import norm import datetime, numpy as np
