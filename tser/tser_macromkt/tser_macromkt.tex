...
Deðiþimin deðiþimini KM þu þekilde hesapliyor: ilki yýl-üzeri-yýl
...
çeyrege bakýlarak yapýlýyor. Böylece elmalarý elmalar ile karþýlaþtýrmýþ oluruz,
mevsimsel farklýlýklar hakkýnda endiselenmek gerekmez. Eger 2010 senesindeki
4. çeyrek, 3. çeyrekten büyük ise, belki bu büyüklük kýþ sezonunda bazý
eylemlerin hep daha fazla yapýlmasýndan ileri geliyordur, yani buyume ``gercek''
degil sezonsaldir. Ama 2010 4. çeyregi 2009 4. çeyregi ile karþýlaþtýrýrsak bu
mevsimsel farklýlýklari hesaba almamis oluruz.

Bu zaman serisi hesaplandýktan sonra ikinci fark hesabý klasik þekilde
yapýlabilir, bir onceki ogeye bakarak. Enflasyon ayný þekilde, YoY, sonra klasik
fark.
...
indisini de hesaba katarsak bir sinüs eðrisinden bahsediyoruz. Her deðiþken KM'e
göre bir sinüs eðrisinde hareket etmektedir; sinüs eðrilerinin de tabii kendine
has parametreleri olabilir, bazýlarý daha geniþtir belki bazýlarý daha dardýr,
genliði kimisinin daha yüksektir. Ama tüm deðiþkenler bir sinüstedir.

O zaman KM metodunun yaptýðý bir deðiþkenin ikinci türevine bakarak sinüs
eðrisinin nerese olduðunu anlamaya uðraþmaktýr.
...
çýkarmak mümkün. Ýki deðiþken ivmeleneme, frenleme üzerinden 4 farklý þekilde
kombine edilebilir; hem büyümede hem enflasyonda ivme vardýr, ya da büyümede
ivme enflasyonda fren vardýr, vs. Bu dört kombinasyonu KM Quad (Bölge) 1, Quad
2, Quad 3, .. diye ayýrýyor. Her quad'ýn kendine has özellikleri, yatýrým
usulleri var.

Quad 1 ýyý, Quad 2 çok iyi. Her iki durumda da büyüme yukarý çýkýyor. Quad 2'de
büyüme ve enflasyon ayný anda yukarý çýkýyor. Bu bölgede herþey kazanýyor, tek
istisnalar altýn, tahviller ve dolar. Kýyasla Quad 4'te büyüme ve enflasyon ayný
anda aþaðý ýnýyor. 
