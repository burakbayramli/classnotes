...
ýnýyor, burada dolar, aþaðý beta defansif hisseler, günlük ihtiyaçlara hitab
...
HE sistemý Quad'lara ek olarak tarihi ve ima edilen oynaklýk [5,6,7] arasýndaki
iliþkiye bakarak ta iþlem yapýyor. Ýma edilen oynaklýk gelecekteki
...
oluþtururuz. Ekler bölümünde opsiyonlarý anlattýk; $\sigma$ tahmininin B-S
formülüne dýþarýdan verilerek opsiyon fiyatlamasý yapýldýðýný biliyoruz. Biz bu
sistematiði tersine çevirerek baþkalarýnýn verdiði opsiyon fiyatlarýndan geriye
giderek oynaklýðý, 'ima edilen oynaklýðý' elde edecegiz.

B-S formülünün türetilmesine burada girmeyeceðiz, onu sadece su sekilde
gösterelim,
...
oraný, $T$ ise opsiyonun bitiþine kadar geçecek zaman. Dikkat edeaarsek $\sigma$
...
\$585, teklif fiyati \$17.50. Yani $V,K,T$ elimizde. Bugünkü (opsiyon bitiþinden
kabaca bir ay önce, 9 Eylül) senet fiyatlarýna bakýyoruz, GOOG \$586.08
seviyesinde, bu da $S$. Risksiz faiz için 4 haftalýk tahvil faizlerine
...
ki oraya bir deðer girerek 17.50 fiyatýný bulmuþlar, biz verilirk fiyat $\sigma$
harici bilinen tüm parametrelerle tek bilinmeyen $\sigma$'yi bulmaya
uðraþacaðýz [8].
...
Bir $f(x)$ için $f(x)=0$ sonucunu verecek $x$ deðerlerini bulmak kök
bulmaktýr. Tabii üstteki problemde fonksiyonu sýfýr olmayan belli bir sabite
olan eþitliðe göre ayarlamak lazým, $f(x) = a$ gibi, ama bu problemi yine kök
bulmaya çevirebiliriz, $g(x) = a-f(x) = 0$ ile mesela. Ardýndan Newton yöntemini
...
Simdi opsiyona baktigimizdaki oynaklik ile bir ay sonrasindaki gercek oynakligi
karsilastiralim. Acaba ima edilen oynakligin tahmin edici kuvveti var mi? 
...
Görüldüðü gibi üstteki hesaptan yüzde 22 elde ettik, yani 8 Eylül'deki yüzde
24'ten bir iniþ tahmin edildi. Bu iniþ gerçekten ortaya çýktý, yüzde 20'ye doðru
bir iniþ oldu, ve bu iniþ üzerinden iþlem yapmýþ olsak para kazanmýþ olurduk.
