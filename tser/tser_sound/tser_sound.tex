...
\begin{document}
Sinüs Bazlý Ses Üretmek, Ses Analizi
...
Ses dalgalarý hakkýnda ilginç bir gözlem, eðer tüm ses dalgasýný alýp yukarý ya
da aþaðý indirsem, seste hiçbir deðiþiklik olmuyor. 
...
Üstteki dosyadaki ses hala orijinali gibi. Ama eðer tüm ses verisini 100 ile
bölseydim, bu ``ses kýsmasý'' demek, ses duyulmayacaktý. 
...
Kendimiz sinüs bazlý ses yaratýyoruz,
...
Fourier Analizi ile Sesi Sinüs Eðrilerine Ayýrmak
...
Eðer sesi oluþturmadan önce önemliliði (significance) 0.05'ten büyük olan
katsayýlarý elersek, 
...
Benim kendi sesimle kaydettiðim 1. resimde gösterilen /ow/ sesi.
