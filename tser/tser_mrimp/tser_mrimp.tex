...
KF hakkýnda detaylar {\em Kalman Filtreleri} yazýsýnda bulunabilir; KF
formüllerinin türetilmesi orada anlatýldý. Bu yazýda gereken bölüþtürme
oraný, ve yan ürün olarak bu oranýn ortalamasýný ve uçuculuðunu (volatility)
hesaplamak, o zaman gizli deðiþken bölüþtürme oraný $\beta$, görünen
(observable) deðiþken ise fiyat zaman serisi $y$ olacak, yani daha önce
basit lineer regresyona $y$ olarak verilen fiyat serisi. Tüm KF modeli,
