...
\verb!pip install chow_test! ile kurulabilecek bir paket var [10], bu paketin
kullanımı,
...
[10] Bobbitt, {\em How to Perform a Chow Test in Python},
    \url{https://www.statology.org/chow-test-in-python/}
