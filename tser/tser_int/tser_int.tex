...
%{{_preview/f-89864509.png}}

$e^r$'nin nasýl limit ile ifade edildiðini görmek için bkz {\em Diferansiyel
  Denklemler, Bir Limit Olarak $e$}. 
...
%{{_preview/f--1574998388.png}}

$$ \approx e^{nr} $$
%{{_preview/f--1977980653.png}}
...
$$ e^{nr} = 2 $$
%{{_preview/f--1837295466.png}}

Ýki tarafýn log'unu alalým,

$$ nr = \log 2 $$
%{{_preview/f--1510017784.png}}

$$ n \approx \frac{\log 2}{r} = \frac{0.693}{r} $$
%{{_preview/f-1934895061.png}}
...
$$ PV = \frac{C}{ (1+r)^i}  $$
%{{_preview/f-627657552.png}}

Ya da

$$ PV = C (1+r)^{-i}  $$
%{{_preview/f--204665443.png}}
...
$$
%{{_preview/f-1973455132.png}}

Üstte kullanýlan eþitlik {\em Diferansiyel Denklemler, Seriler} bölümünde
gösterildi. Þu eþitlik,

$$ 1 + b + b^2 + ... + b^n = \frac{1-b^{n+1}}{1-b} $$
%{{_preview/f--1366196877.png}}
...
%{{_preview/f-755542813.png}}

$$ \frac{\beta (1-\beta^{180})}{(1-\beta)} = 98,000 / 910 = 107.69$$
%{{_preview/f-1884150166.png}}
