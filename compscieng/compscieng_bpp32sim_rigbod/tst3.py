...
if not os.path.exists("/tmp/rotate"): os.mkdir ("/tmp/rotate")

#file = '../../sk/2020/08/shapes/pyramid_pentagon.stl'
#file = '../../sk/2020/08/shapes/Cylinder.stl'
file = '../../sk/2020/08/shapes/torus2.stl'
...
f_at = 1 * 2 * your_mesh.get_unit_normals()[tidx]
tau0 = np.cross(apply_at, f_at).reshape(1,3) 
...
for i in range(30):
   ...
   mesh0 = mesh.Mesh.from_file(file)  
