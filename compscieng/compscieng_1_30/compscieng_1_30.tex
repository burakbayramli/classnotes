...
Fourier analizine gelelim: {\em Diferansiyel Denklemler Ders 15}'te surekli
Fourier Transformunu gorduk,
...
$j$ ise hayali sayý $j = \sqrt{-1}$.  Euler iliþkisi
$e^{-j\phi} = \cos(\phi) - j\sin(\phi)$'den hareketle üstteki ayrýksal
denklem alttakine eþittir,
...
Þimdi $x(n)$ girdisine DFT uygulayacaðýz. $X(1)$ için (1) formülü suna
benzer,
...
[Alttakiler Strang hocanýn dersinden notlardýr]:
