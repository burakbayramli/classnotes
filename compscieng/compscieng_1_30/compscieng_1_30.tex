...
$k=2$ ve $5$'te büyüklük var, bu deðerler $k\omega_0 = 2\pi k / NT$ ile
$\pi$ bazina cevirilebilir, $k=2$ icin $2\pi k / 3.2 = 1.25 \pi$ olur,
$k=5$ icin $3.125 \pi$ elde ederiz.

Ders 15

[Strang hocanýn notlarýndan. Üstteki DFT hesabý, toplamlar, döngüler
içinde, belli indisler için yapýldý. Altta Strang hocanýn anlattýðý ilginç
bir yaklaþým var, bir sinyalin o sinyalin frekanslarýnýn katsayýlarla
aðýrlýklanmýþ toplamý olduðu temel Fourier formülü ile baþlarýz, fakat
diðer yöne gitmek için pür lineer cebir kullanýrýz, böylece katsayý hesabý
bir matris tersi alma iþlemi haline gelir].
