...
ya da tüm eksenlere daðýlmýþ olarak ölçülecektir [4]. Yürürken, adým
atarken meydana çýkan yukarý ve aþaðý yönde kuvvet uygulamasý da
ivmeölçerlerle yakalanýr. Bu ölçümleri kullanarak acaba atýlan adým
sayýsýný bulamaz mýyýz? [5]'deki uygulamayý kullanarak alýnan ölçümlere
bakalým,
...
karekökü) - daha önce belirtildiðimiz gibi telefonun duruþu deðiþik
...
Fourier analizine göre yerçekimi çýkartýlmýþ verinin ilgilendiðimiz
...
plt.plot(x[indexes], y[indexes], 'rd')
plt.savefig('compscieng_app60wave_16.png')
\end{minted}

\includegraphics[height=4cm]{compscieng_app60wave_04.png}
\includegraphics[height=4cm]{compscieng_app60wave_05.png}
\includegraphics[height=4cm]{compscieng_app60wave_16.png}
...
[4] Daskalov, {\em A Pedometer in the Real World}, \url{http://www.aosabook.org/en/500L/a-pedometer-in-the-real-world.html}
