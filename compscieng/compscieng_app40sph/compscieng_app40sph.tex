...
Ayrýca üstteki toplamýn teoride tüm parçacýklar üzerinden alýndýðý gösterildi,
fakat pratikte $r$'ye yakýn olan diðer parçacýklar üzerinden alýnýr, çoðunlukla
...
Üstteki formül bana herhangi bir $r$ noktasýnda hesaplayabileceðim bir $A$
kestirme hesabý (estimation) vermiþ oldu. Parcaçýk bazlý simulasyon yaptýðýmýz
için her $i$ parçacýðý çevresindeki $j$ parçacýklarý üzerinden bu kestirme
hesabý yapabileceðiz.
...
olarak [10]'da bulunabilir, C++ versiyonu [11]'de.
