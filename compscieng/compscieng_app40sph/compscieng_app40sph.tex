...
eþsýcaklýk (isothermal) sývý kabul edilir, ve parçacýklarýn sayýsý simulasyon
sýrasýnda deðiþmez kabul edilir, o zaman üstteki formülün sað tarafýnda bir gaz
sertlik sabiti $k$ kullanýlabilir [4, sf. 18],
...
ki her basýnç hesabý için yoðunluðun bu baz $\rho_0$ ile olan farkýna bakýlýr,
nihai formül,
