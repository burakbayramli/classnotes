...
gaz parçacýðý olduðu, $R$ evrensel gaz sabiti, $T$ ise sýcaklýk. SPH için
eþsýcaklýk (isothermal) sývý, ve parçacýklarýn sayýsý simulasyon sýrasýnda
deðiþmez kabul edilir, o zaman üstteki formülün sað tarafýnda bir gaz sertlik
(stiffness) sabiti $k$ kullanýlabilir [4, sf. 18],
