...
Benzer hesapları yapan C++ kodu alttadır. 

\inputminted[fontsize=\footnotesize]{c}{simsph2.cpp}

Kod çıktıyı CSV dosyalarına yazıyor, oradan grafikleme rutini ile kare kare tüm
grafikleri basıyoruz, 

\inputminted[fontsize=\footnotesize]{c}{simsph2.py}

ve animasyonu üretiyoruz.

\verb!convert -scale 70% -delay 30 /tmp/simsph/*.png /tmp/simsph.gif!
