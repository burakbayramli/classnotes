...
tuðla duvarýnýn önemli bir avantajý (ters Fourier transformu ile) zaman
yöresine geçiþ yapýldýðýnda yine basit bir fonksiyon olmasý, bu ünlü
$\sinc$ fonksiyonudur,
...
kullanýþlý deðil. Bunun için fonksiyonu bize sýfýrda ortalanmýþ $M$ tane
katsayý deðeri býrakacak þekilde kýrpacaðýz ($M$ çift sayý olmalý, her iki
yönde eþit katsayý olmasý için), ve geri kalan tüm $\sinc$ deðerleri sýfýr
kabul edilecek. 
