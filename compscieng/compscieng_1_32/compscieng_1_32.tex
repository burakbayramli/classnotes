...
tanýmlayýp numpy.fft.ifft ile $h$'yi elde edelim,
...
plt.figure()
plt.plot(H)
plt.savefig('compscieng_1_32_02.png')
h1 = np.fft.ifft(H,140)
h = np.real(np.fft.ifftshift(h1))
plt.figure()
plt.plot(h)
plt.savefig('compscieng_1_32_01.png')
\end{minted}

\includegraphics[width=15em]{compscieng_1_32_02.png}
\includegraphics[width=15em]{compscieng_1_32_01.png}
...
vuruþlu (33-tap) filtreler'' denebilir. 
