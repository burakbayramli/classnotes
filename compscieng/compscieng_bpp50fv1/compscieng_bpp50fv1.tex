...
Daha önce tek boyutlu lineer tasinim akımı (convection) ile gördüğümüz durum
...
hızının hesabı için kesinti bölgesinin yeterine uzağında $M$ ve $-M$ noktalarını
seçelim, bu iki nokta arasındaki toplam kütlenin / dalganın değişiminin hızı
şok hızı $s$ olacaktır.
...
Böylece genel bir ifade elde ettik. Burgers denklemi için şok hızı nedir?
