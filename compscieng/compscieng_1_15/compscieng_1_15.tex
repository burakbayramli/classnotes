...
formülü en az kareler çözümü olarak biliniyor, bkz {\em Lineer Cebir Ders
  16}. Bu çözüm iyi iþler, fakat bazý durumlarda negatif bir tarafý var,
çözüm toptan (batch) olarak yapýlýyor. $A$ içinde 100 tane satýr
olabilir, ona göre bir çözüm bulunur, ardýndan 1 tane ek veri satýrý
gelirse olsa 101 tane satýr için tüm iþlemlerin tekrar baþtan yapýlmasý
gerekir. Acaba sadece o yeni verilen satýr için önceki $x$ tahminini
bir þekilde güncellemek mümkün mü?
