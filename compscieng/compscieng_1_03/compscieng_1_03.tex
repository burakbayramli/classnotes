...
Eliminasyon iþlemlerini yapalým. 
...
$$
\left[\begin{array}{rrr}
\textcolor{green}{1} & -1 & 0 \\ -1 & 2 & -1 \\ 0 & -1 & 1
\end{array}\right]
\to
\left[\begin{array}{rrr}
\textcolor{green}{1} & -1 & 0 \\ 0 & \textcolor{green}{1} & -1 \\ 0 & 0 & \textcolor{green}{0}
\end{array}\right] 
$$
...
$$
\left[\begin{array}{rrr}
\textcolor{green}{2} & -1 & 0 \\
0 & \textcolor{green}{3/2} & -1 \\
0 & 0 & \textcolor{green}{4/3}
\end{array}\right] = U =
\left[\begin{array}{rrr}
2 & & \\ & 3/2 & \\ & & 4/3
\end{array}\right] 
