...
Doruk bulmaktaki farklý parametre etkilerini þöyle gösterelim. Önce
gürültülü, iki büyük tepeden oluþan bir yapay veri üretelim,
...
Þimdi farklý parametrelerle doruk noktalarý bulalým,
...
0.5 ile tanýmlanabilir, o zaman sadece bu deðer üstündeki noktalar doruk
olarak saptanacaktýr. Yatay yönde ama bu sefer reel deðer bazlý bir eþik
deðeri \verb!min_dist! ile verilir, bu durumda doruk noktalarý arasýnda en
