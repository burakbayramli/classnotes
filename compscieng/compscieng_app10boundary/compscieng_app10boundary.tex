...
Bilinmeyen baþlangýç þartlarýndan birinin bulmak için bir yöntem, tüm
...
deðiþken tanýmlayalým, $x_1'(t) = x_2(t)$ olsun, o zaman $x_2'(t)$ bir ana
ODE denklemi olabilir, çok boyutlu olarak 
