...
lazým. Birleþtirme için Android ortamýnda rotasyon matrisi [3] bazlý bir
...
eþlemesine ihtiyaç yok. Bir diðer problem bu hesabýn nasýl
kullanýlacaðý... Mesela ivme hesaplarýný rotasyon matrisi ile dünya
kordinat sistemine çevirdik, þimdi kuzey-güney doðu-batý baðlamýnda
ivlenmeyi ``biliyoruz''. Bu ivmelenmeyi bir kere sayýsal entegrasyon ile
hýza çevirip oradan yön elde edebilir miyiz?  Ne yazýk ki entegrasyon
hassas bir hesaptýr. Eðer olmayan yerde birkaç saniye bile fazla ivme
ölçümü almýþsak, hýzda, yönde aþýrý farklýlýklar ortaya çýkabiliyor.
...
Not: Bu tür problemler ile karþýlaþtýklarýnda bugünlerde moda olan veri
bilimi denen meslekteki bazý arkadaþlarýn ilk refleksi elde olan bir sürü
veriyi bir yapay öðrenim algoritmasina týkmak olabiliyor, yapay öðrenim
algoritmasý bir þeyler ``öðreniyor'', ve birdenbire bize yeni veriler /
ortamlar için doðru sonuçlar vermeye baþlýyor. Çoðunlukla denetimli iþleyen
bu ortamlar için gereken veri hazýrlýðýnýn külfeti bir tarafa, bu yaklaþým
her zaman iþlemez, iþlese bile ortaya kýrýlgan bir sistem çýkabilir,
problem alanýný yakýndan gözlemek her zaman daha faydalýdýr. Problemi elden
geldiði kadar matematiksel olarak modellemeye uðraþmamýz lazým. Aradýðýmýz
çok hassas olmayan, genel, geniþ, tekrar eden bir kalýp, sinyali
yakalamak. Bunu da ancak olan biteni yakýndan gözlemleyerek
bulabiliriz. [1]'deki Walkcompass araþtýrmasýnýn yaptýðý tam da budur.
...
yaptýðý anlardýr. Ardýndan sýfýr geçiþ ve tepe noktalarý arasýndaki bölgeye
odaklanýlýr, ve bu kesit çýkartýlarak ortalamasý alýnýr. Bu ortalama
telefonun tüm eksenlerindeki ivme ölçüsü olacaktýr, sonuç üç boyutlu bir
...
kaydettiðimiz verilerle yürüyüþ yönü vektörü hesabýný görüyoruz.
...
Yürüyüþ yönünü telefon eksenleri bazlý saptadýk, peki bu yönün dünya
üzerinde hangi yön olduðunu nasýl anlayacaðýz? Pusulayý kullabiliriz, cep
telefonlarý pusula algýlayýcýsý ile kuzey manyetik etkisinin telefon
eksenlerine ne kadar etki ettiðini kaydedebiliyor, yani bu üç eksenden
alýnan üç veri noktasý bir vektör olarak telefon kordinat sisteminde
kuzeyin neresi olduðuna iþaret edecektir. 

Son durum þöyle olabilir, bir telefonun standart elde tutuluþ tarzýný baz
alalým,

\includegraphics[width=15em]{compscieng_app40walk_14.png}

Güzel, þimdi bu vektörleri kullanarak gidiþ yönünü bulalým. Üstteki
vektörlerin üç boyutlu olduðuna dikkat, bize aslýnda gereken sadece kuzeye
göre nasýl hareket ettiðimizi verecek tek bir açý. Þimdi iþimizi
kolaylaþtýracak bir yeni kavramý daha kullanabiliriz: yerçekim
vektörü. Yerçekim ivmeölçerler tarafýndan sürekli kaydedilir, yerçekimi
müthiþ bir kuvvettir, 9.8 $m/s^2$ ile sürekli üzerimizde etkisi var. Bunun
iyi tarafý telefonlar bu kuvveti, ve onun yönünü bir vektör olarak
güvenilir bir þekilde hesaplayabilirler. Hatta Android'in bu vektörü ivme
verisinden çýkartan bir ``türevsel algýlayýcýsý'' bile var. Yerçekim vektör
...
edersek, bu üzerinde durduðumuz yeryüzeyi olacaktýr! Eðer pusula ve yürüyüþ
yönü vektörlerini bu düzlem üzerinde yansýtýrsak, artýk bu iki vektör
arasýndaki açýyý bulmak çok basittir. Yansýtma için bkz {\em Lineer Cebir,
  Ders 15}. Açý hesabý için iki vektor arasýndaki þu iliþkiyi hatýrlayalým,
...
olsun iþler. Bu çok faydalý çünkü telefon cebimizde, çantada herhangi bir
þekilde duruyor olabilir, fakat þimdiye kadar gördüðümüz tüm vektörleri
hesapladýðýmýz anda kuzeye referanslý hangi yönde yürüdüðümüz gayet rahat
þekilde bulabiliriz. 
