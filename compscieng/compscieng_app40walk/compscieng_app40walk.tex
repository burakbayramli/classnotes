...
threshold = 0.1
order=4
stride_fraction = 1.0/8.0 # verinin kacta birine bakalim
\end{minted}
...
vektörlerin üç boyutlu olduðuna dikkat, eðer bu iki vektör arasýnda direk
açý hesaplamaya uðraþsak, diyelim biri çok yukarýda diðeri çok aþaðýda ama
yeryüzü bazýnda doðu-batý temelli çok az farklý olan iki vektör arasýnda
çok büyük açý ortaya çýkacaktýr. Bize aslýnda gereken sadece kuzeye göre
nasýl hareket ettiðimizi verecek ``yataysal'' bir acý. Þimdi iþimizi
kolaylaþtýracak bir yeni kavramý daha kullanabiliriz: yerçekim
vektörü. Yerçekim ivmeolcerler tarafýndan sürekli kaydedilir, yerçekimi
