...
gerekiyor, ki [1, 2]'deki araþtýrma aynen bunu yapmýþ. Bugünlerde moda olan
veri bilimi denen bir meslek var, burada bazý mühendislerin ilk refleksi
elde olan bir sürü veriyi bir yapay öðrenim algoritmasýna vermek
olabiliyor, ve yapay öðrenim algoritmasý bir þeyler ``öðreniyor'', ve
birdenbire bize yeni veriler / ortamlar için doðru sonuçlar vermeye
baþlýyor. Bu yaklaþým her zaman iþlemez, problem alanýný yakýndan gözlemek
her zaman faydalýdýr, onu elden geldiði kadar matematiksel olarak
modellemeye uðraþmamýz lazým. Aradýðýmýz çok hassas olmayan, genel, geniþ
tekrar eden bir kalýp, bir sinyal, amacýmýz bu kalýbý yakalamaya uðraþmak.
