...
threshold = 0.1
order=4
# sallanis bolumunu kac kesite bolelim (ki 
# ilgilendigimiz son kesit). [1]'e gore 1/4, 
# altta 8 parcaya boluyoruz.
...
çok büyük açý ortaya çýkardý. Bize aslýnda gereken sadece kuzeye göre nasýl
hareket ettiðimizi verecek ``yataysal'' bir açý. Þimdi iþimizi
