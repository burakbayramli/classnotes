...
biz izleyicileri biraz þýmarttý aslýnda -zamanda seyahat, istediði yere
inen uzay gemileri, ýþýktan hýzlý seyahat- fakat cep telefonu ile yürüyüþ
yönünü hesaplamak 2014 civarýna kadar hala tam, genel bir þekilde çözülmüþ
deðildi. GPS ise yaramýyor mu? GPS kesin çözüm olabilirdi çünkü dünya
üzerinde global kordinatlarý direk cihaza alýyoruz, fakat GPS þehir
ortamýnda binalardan sinyal yansýmasý (multipath) problemi sebebiyle
herhangi bir yönde birkaç yüz metre hatalý olabiliyor, ve kapalý alanlarda
zaten hiç GPS sinyali alamýyoruz. Baþka bir yöntemi kullanmamýz gerekiyor.
...
Bu birleþtirme için Android ortamýnda rotasyon matrisi [3] bazlý bir
yöntemi tavsiye edenler var; bu yönteme göre ivmeölçer ve pusula
birleþtirilip kamera kordinat sistemini dünya kordinat sistemine tercüme
edecek bir matris hesaplanýyor. Fakat bu hesap hareketli ortamda tam
güvenilir deðil, ayrýca hesaplanan çok boyutlu bir ürün. Bu tür girift ara
ürünler nihai çözümdeki hata ihtimalini daha arttýrýr, bize gereken tek bir
yön sadece, {\em tüm} üç boyutlu eksenin bir diðer üç boyutlu eksene direk
eþlemesi deðil. Bir diðer problem bu hesabýn nasýl kullanýlacaðý... Mesela
...
Not: Bugünlerde moda olan veri bilimi denen bir meslek var, buradaki bazý
arkadaþlarýn ilk refleksi elde olan bir sürü veriyi bir yapay öðrenim
algoritmasina týkmak olabiliyor, yapay öðrenim algoritmasi bir þeyler
``öðreniyor'', ve birdenbire bize yeni veriler / ortamlar için doðru
sonuçlar vermeye baþlýyor. Çoðunlukla denetimli iþleyen bu ortamlar için
gereken veri hazýrlýðýnýn külfeti bir tarafa, bu yaklaþým her zaman
iþlemez, iþlese bile ortaya kýrýlgan bir sistem çýkabilir, problem alanýný
yakýndan gözlemek her zaman daha faydalýdýr. Problemi elden geldiði kadar
matematiksel olarak modellemeye uðraþmamýz lazým. Aradýðýmýz çok hassas
olmayan, genel, geniþ, tekrar eden bir kalýp, sinyali yakalamak. Bunu da
ancak olan biteni yakýndan gözlemleyerek bulabiliriz. [1]'deki Walkcompass
araþtýrmasýnýn yaptýðý tam da budur. 

\includegraphics[width=30em]{compscieng_app40walk_13.png}

[1]'e göre insan yürüyüþünün bölgelere ayrýlabilir ve her bölgenin
ivmeölçerde farklý bir yansýmasý var. Ýki büyük bölge duruþ ve sallanýþ
...
bacaðýn arkadan öne doðru itilmesiyle üst gövdeden öne geçme aný. Sallanýþ
bölgesinin ilk kýsmýnda ivme pozitif, ikinci kýsmýnda ise negatif. Ayrýca,
diyelim ki sallanýþ $t_1,..,t_9$ zaman kesitlerini kapsýyor, ivme $t_3$'te
maksimum, $t_5$'te sýfýr, ve geriye doðru ters ivme (deceleration) $t_7$'de
en üst noktasýnda. 

Araþtýrmanýn en önemli bulgusu þudur: güvenli bir þekilde ivmeölçere
yansýyan ve yürüyüþ yönü bilgisini taþýyan en iyi bölge topuk vuruþuna
giden maksimum yavaþlamanýn olduðu bir bölge, bunun için [1] önce ivme
sinyalinde aþýrý yüksek frekanslý sinyalleri eler, ardýndan sýfýr geçiþ
anlarýný bulur - bu noktalar sinyalin artýdan eksiye doðru geçiþ yaptýðý
anlardýr. Ardýndan sýfýr geçiþ ve tepe noktalarý arasýndaki bölgeye
odaklanýlýr, ve bu kesit çýkartýlarak ortalamasý alýnýr. Bu ortalama
telefonun tüm eksenlerindeki ivme ölçüsü, ve sonuç üç boyutlu bir
vektör. Vektörün iþaretini tersine çevirirsek (yavaþlama yönünün tersi) bu
bize yürüyüþ yönünü verecektir. 

Alttaki kodda bizim [5]'teki bir uygulama {\em Steps}'i kullanarak
kaydettiðimiz veriler üzerinden telefon eksenleri üzerindeki yürüyüþ yönü
vektörünü hesaplýyoruz.
...
# Veri uzerinde alcak geciren (low-pass) Butterworth filter filtre islet,
...
Yürüyüþ yönünü telefon eksenleri üzerinde saptadýk, peki bu yönün dünya
üzerinde hangi yön olduðunu nasýl anlayacaðýz? Burada pusulayý
kullabiliriz, cep telefonlarý pusula algýlayýcýsý ile kuzey manyetik
etkisinin telefon eksenlerine ne kadar etki ettiðini kaydedebiliyor, yani
bu üç eksenden alýnan üç veri noktasý bir vektör olarak telefon kordinate
sisteminde kuzeyin neresi olduðuna iþaret edecektir. Son durum þöyle
olabilir, bir telefonun standart elde tutuluþ tarzýný baz alalým, 

\includegraphics[width=15em]{compscieng_app40walk_14.png}

Güzel, þimdi bu vektörleri kullanarak gidiþ yönünü nasýl buluruz? Üstteki
vektörlerin üç boyutlu olduðuna dikkat, bize aslýnda gereken sadece kuzeye
göre nasýl hareket ettiðimizi verecek tek bir açý. 

Burada iþimizi kolaylaþtýracak bir yeni kavramý daha kullanabiliriz:
yerçekim vektörü. Yerçekim ivmeolcerler tarafýndan sürekli kaydedilir,
yerçekimi müthiþ bir kuvvet, 9.8 $m/s^2$ ile sürekli üzerimizde etkisi olan
bir þey. Bunun iyi tarafý telefonlar bu kuvveti, ve onun yönünü bir vektör
olarak güvenilir bir þekilde hesaplayabilirler. Hatta Android'in bu vektörü
ivme verisinden çýkartan bir ``türevsel algýlayýcýsý'' bile var. Yerçekim
vektör algýlayýcýsý (gravity vector sensor) hýzlý bir þekilde bu hesabý
veriyor. Telefon hangi konumda olursa olsun yerçekimin, yine telefon
kordinatlarýna göre, hangi yönde olduðunu bulabiliyoruz. 

Yerçekim vektörünün faydasý þurada: bu vektörün normal olduðu düzlem
üzerinde durduðumuz yeryüzeyi olacaktýr. Eðer pusula ve yürüyüþ yönü
vektörlerini bu düzlem üzerinde yansýtýrsak, artýk bu iki vektör arasýndaki
açýyý bulmak çok basittir.
...
vektörsel olarak ise, ama ölçümdeki deðiþiklik, hata her ne ise, {\em
  tutarlý} ise vektörün tüm öðelerinde mevcut olacaktýr, ve vektörün
yönünde deðiþiklik olmayacaktýr. Vektörler, düzlemler, tek açýlar ile iþ
yaparak, tek bir amaca odaklý algýlayýcýlarýn verisine güvenerek ve onlarý
bir araya getirerek iþimizi kolaylaþtýrmýþ olduk.
