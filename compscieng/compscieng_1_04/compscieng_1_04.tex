...
Bu denklemi çözmek için karakteristik denklemini buluruz (bkz {\em
  Diferansiyel Denklemler, Ders 9}). Bu denklem $-r^2 + r = 0$ olacaktýr,
kökleri $0$ ve $1$, o zaman homojen denklemin çözüm yelpazesini $e^{0x}=1$
ve $e^{x}$ tanýmlar. Genel çözüm demek ki
