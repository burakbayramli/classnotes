...
bağlandığındaki açılar aynı kalır. Düğüm noktalarında bürümsal ve bükülme
momentleri süreklilik gösterir. İzgara örnekleri bir evin tabanı (floor) ya da
bir köprünün alt yüzeyi olabilir [3, sf. 262].

\includegraphics[width=20em]{compscieng_bpp43fem_01.jpg}

Ama izgara denklemlerine detaylı giriş yapmadan önce Galerkin, ve şekil
...
ve $x$ ile çarpıp başlangıç değerine eklemek. Mesela alttaki çubuğu
düşünelim [3, sf. 264],

\includegraphics[width=15em]{compscieng_bpp43fem_02.jpg}

Eger bir $\phi'$ acisi 1 noktasinda $\phi'_{1x}$ 2 noktasinda $\phi'_{2x}$
olsun istiyorsak ve aradaki degisim lineer ise,
...
Maksimum kaykilma gerginligini bulmak icin daha onceki formulu hatirlayalim,

$$
\gamma_{max} = \frac{R \ud \phi'}{\ud x'}
$$

Herhangi bir $r$ yaricapi icin
...
Lineer elastik esyonlu (isotropic) materyeller için kaykılma stresi $\tau$
