...
filtreler (linear time ýnvariant filters) ismi de veriliyor, çünkü her
...
Bazýlarýnýn aklýna determinantý hesaplamak gelebilir. Fakat hocanýn ilk
seçimi bu deðil. Onun tercihi satýr indirgemek (row reduce). Tavsiyesi bu,
önünüzde bir matris var, ve içinde neler olup bittiðini
bilmiyorsunuz. Satýr indirgeyin. 
...
satýrýn 2/3'unu alta eklersek, oradaki -1 sýfýrlanýr. 
...
yokedecekti. Peki determinantin deðeri nedir? 5. Niye 5? Çünkü elimizdeki
...
1. dersin amaçlarýndan biri matrislere ýþým vermek. $K$ matrisi bunlardan
...
Fiziksel olarak $K$ ve $C$'nin kütle ve yay sistemi olarak kabul
...
yine ayný \verb!ü = [1 1 1 1]! ispatýný kullanabiliriz. 
