...
Frekans Filtreme, IIR Filtreleri
...
fonksiyonu var. Aslýnda çok basit, 
...
= \frac{20T}{1 - e^{-20 T}z^{-1}} \mlabel{4}
$$
...
veriyor. $a_0 = 1.0$, $a_1=-e^{-20T}$, $b_0 = 1.0$, $b_1 = 20T$. Bu þekilde
seçtik çünkü \verb!scipy.signal.lfilter! ile uyumlu olmasýný istedik, bu
kütüphane,
...
Böylece biri 2 diðeri 7 Hz ile üretilmiþ iki sinyali üst üste
koyduk. Filtreleme ile bunu ayrýþtýrmaya uðraþalým,
...
\begin{verbatim}
[ 0.42080778  0.42080778] [ 1.         -0.15838444]
\end{verbatim}
...
(çiftlineer transform olmalý). Eðer vuruþ sayýsýný arttýrýrsak, yani daha
fazla katsayý ile
