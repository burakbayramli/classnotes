...
dürtü deðiþmezliði (impulse invariance) yöntemi. DD ile bilinen bir analog
...
1 rad/s is $1/2\pi$ Hertz.

$$ H(z) = \frac{20}{1 - e^{-20 \times 0.05} z^{-1}}$$

$$ H(z) = \frac{20}{1 - 0.36787 z^{-1}}$$

$$ y[n] = 0.36787 y[n-1] + 20 x[n]$$
...
\begin{verbatim}
[1.0, 2.0] [1.0, -0.1353352832366127]
\end{verbatim}
