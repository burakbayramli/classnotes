...
Basit bir ornek uzerinde gorursek, mesela $\Phi(x,y) = x^2 + y^2$. Bu
fonksiyonun kesit seviyelerini nasil alirim? $\Phi$'yi bir sabite esitleyerek bu
seviyeleri elde edebilirim, $\Phi(x,y) = x^2 + y^2 = c$. $c$ pozitif oldugunda
elde edilen sonuclar cember olacaktir tabii, bu formul klasik, unlu bir formul.
