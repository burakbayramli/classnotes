...
yaklaþýksal (approximate) formülü görelim. Deðiþim matematiksel olarak
þöyle
...
Tekrar vurgulamak gerekirse bu yaklaþýksal bir formül, daha ``doðru'' bir
temsil için 2., 3. türevleri içeren daha yüksek dereden (higher order
...
bir düzlem tanýmlamak için yeterlidir), ki teðet düzlem yaklaþýksallamasý
...
Formül (1), ustteki formülün yaklaþýksal halidir. Eðer teðet düzlem
üzerinde olsaydýk, $\approx$ iþareti $=$ iþaretine dönüþecekti. Bu
yaklaþýksallýk ufak $\Delta x$ ve ufak $\Delta y$ için geçerli. Yani
yaklaþýksal formül, $f$'nin grafiði teðet düzleme yakýn diyor. 
...
sürece (ki lokallýðýn tanýmý bu) bu minimum geçerlidir. Baþka bir noktada,
...
Yanlýz bir diðer seçenek daha var. Bu seçenek kritik noktanýn ne maksimum,
...
çýkmýþtýr. Kuralýn ölçtüðü bir mikropçipin içine koyulabilecek transistör
