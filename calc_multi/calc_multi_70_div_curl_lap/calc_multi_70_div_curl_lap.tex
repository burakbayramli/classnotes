...
Bir üç boyutlu vektör alaný, ve onun analitik olarak curl hesabýný verelim,
...
Sað el kuralýndan ve akýntýya bakarak bu sonucun doðru olduðunu görebiliriz.

Þimdi sayýsal olarak curl kodlamasýna bakalým, bu kod da \verb!gradient!
çaðrýlarý yaparak ve sonuçlarý iþleyerek bir curl hesabý yapýyor. 
...
[10]. Alttaki kodda ufak bir bölgedeki rüzgar hýzýný grafikliyoruz, ve ortasýnda
curl hesabý yapýyoruz.
