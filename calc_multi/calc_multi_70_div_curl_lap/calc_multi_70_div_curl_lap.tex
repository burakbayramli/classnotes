...
Bu hesap, isminin çaðrýþtýrabileceði üzere bir vektör alanýnýn döndürme etkisini
özetler. Mesela içinde dalgalar, akýmlar olan bir sývýya ufak bir küre attýk. Bu
küre o sývýnýn hareketlerine, yani $F$'sine göre, belli bir þekilde dönmeye
baþlayabilir, bu dönüþü özetlemenin iyi bir yolu curl hesabýdýr.
