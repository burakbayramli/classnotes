...
attýk. Bu kürenin o sývýnýn hareketlerine, yani $F$'sine göre, belli bir þekilde
...
götürüp sonsuz küçükltunce bir analitik sonuca eriþmiþ olacaðýz.
...
Tüm bu bileþenleri bir araya koyunca (2)'de gösterilen curl vektörüne ulaþmýþ oluyoruz.
...
ci,cj,ck=CurlFinDiff(u,v,w,0.2,0.2,0.8)

i,j,k=1,3,2
ax.quiver(x[i,i,k], y[i,i,k], z[i,i,k], ci[i,i,k],cj[i,i,k],ck[i,i,k], length=0.2)
i,j,k=3,3,0
ax.quiver(x[i,i,k], y[i,i,k], z[i,i,k], ci[i,i,k],cj[i,i,k],ck[i,i,k], length=0.2)
