...
Örnek bir $F$ içinde görelim. Alttaki oklar belli noktalarda verili bir akýþý
gösteriyor. Bu akýþýn $z$ ekseni etrafýndaki etkisini (curl'ün bir bileþeni bu
ölçümdür) ölçmek için bir çubuk etrafýnda dönebilen bir küreyi o akýþýn içine
soktuk. 

\includegraphics[width=15em]{calc_multi_70_div_curl_lap_06.png}

Küre $z$'yi döndürebilecek etkiler üzerinedn dönecektir. Bu dönüþü $F$
bileþenleri ile nasýl ilintilendiririz?

Bu ilinti için üstteki duruma kuþbakýþý olarak bakalým, yani $z$ ekseninden
aþaðý doðru, bu  alttaki resmi veriyor,

\includegraphics[width=15em]{microscopic_circulation_vector_field_change.png}
...
[8] Mathinsight, {\em The components of the curl},
    \url{https://mathinsight.org/curl_components}
