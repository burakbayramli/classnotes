...
Diyelim ki $F$'nin ufak bir dikdörtgen etrafýnda yaptýðý dönüþsel iþi,
dolaþýmýný (circulation) hesaplayacaðýz. Sonra dikdörtgeni limite götürüp sonsuz
küçükltunce bir analitik sonuca eriþmiþ olacaðýz.
...
$$
\int_{C_B} F_x \ud x \approx F_x \left( x,y-\frac{\Delta y}{2}, z \right) \Delta x
$$
