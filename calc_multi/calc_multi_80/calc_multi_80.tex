...
Uzaklaþým (divergence) $\bdiv f$, ya da $\nabla \cdot f$ ile gosterilir, 
...
$\nabla \cdot f$ notasyonu aslýnda þuradan geliyor, üstteki hesabý
$f$'nin gradyaný ve $f$'nin kendisi arasýnda bir noktasal çarpým
olarak görebiliriz. 
...
Curl hesabini $\nabla$ bazinda yapabilir miyiz? Evet, 
