...
Ýki deðiþkenli bir fonksiyonu gösterebilmek için 
\begin{center}
...
Bir kontur grafiði üzerindeki çizgilerin her biri, bir yüksekliðe tekabül eder. 
Mesela $f(x,y)=1$ eþitliði için olan tüm $x,y$
noktalarý üstte en dýþtaki kapalý eðridir, $f=2$, $f=3$, vs ayný þekilde. Üç
...
\end{center}
$x$ noktasýndaki eðim $f'(x)$'e eþittir. 
