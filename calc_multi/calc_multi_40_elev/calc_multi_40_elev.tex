...
Autoðrad, Otomatik Türev

Þimdiye kadar gördüðümüz yöntem gradyan, türev bilgisinin sayýsal olarak
hesaplayan bir yöntem kullandý, ÇOBYLA. Fakat gradyan bilgisini `autoðrad`
ile hesaplatýp optimizasyon adýmýný kendimiz de atabilirdik. 
