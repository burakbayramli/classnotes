...
baþka eðri. Bu eðrilerin {\em uzunglunu} hesaplarsak ve dikey yöndeki
...
eðri üzerinde alýnacak tabii ki. Problem çözümü açýsýndan $\ud z/\ud t$
hesabý külfetli olabilir, üstteki örnekteki yükseklik fonksiyonu basit, ama
daha çetrefil durumlarda da kullanabileceðimiz bir yaklaþým daha iyi
olur. Biz bu türevi hesapsal yapacaðýz.

Ama yatay türevler, bunlarýn karesi hesaplarýný sembolik olarak
yapabiliriz, çünkü bu formül polinom, formu þimdiden belli.
...
Entegrallerin hesabýna gelelim, bu hesaplar da sayýsal yapýlacak. 
