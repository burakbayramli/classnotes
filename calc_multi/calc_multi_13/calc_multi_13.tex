...
tekniklerinin burada ise yarayamayacaðýný hemen belirtelim. O kritik noktalar
...
\lambda \nabla g $ ifadesinin 
doðru olduðu bir nokta, ve $\lambda$ deðerini arýyoruz (unutmayalým,
gradyanlar belli $x,y$ deðerleri üzerinde alýnýr). Yani 2 deðiþken içeren
sýnýrlama  ifadesi $g(x,y)=c$ içeren bir min
/ maks problemi yerine, bir denklem sistemi geçiriyoruz. Bu sistem nedir?
Üstteki gradyan formülüdür, o da þu sisteme dönüþür:
...
Bu sistemi çözmemiz gerekiyor. Yalnýz þunu söyleyelim, bu sistemi çözmenin genel
...
Üstteki son iki resme bakýnca, $\lambda = 2$'nin doðru olduðunu görüyoruz,
...
Kýsýtlý ifade göz önüne alýnýnca ele geçecek bir min / maks noktasýnda ve
...
ilerliyorsak, $f$'in (en azýndan birinci derecedeki yaklaþýksaklamasýndaki)
...
bakarýz, birbirleri ile karþýlaþtýrýrýz. Mesela üstteki örnekten elde
...
olabilecek, ve nerede olduðuna göre hacmin, alanýn deðiþebileceði
...
\end{center}
Eðer koordinatlarý üstteki gibi ortaya çýkartsak, ele geçen tüm üçgenlerin
...
fazla karýþtýrýyor. Koordinatlarý daha iyi temsil edecek bir yöntem
gerekiyor bize.
\begin{center}
...
kullanarak hangi $P$ noktasý için bu kutunun en büyük hacme sahip
...
``sekiz'' anlamýna geliyor, ki alttaki 3D koordinat sistemi 8 parçaya
...
$x,y,z$ sýfýr olduðu, yani orijinde olduðu zamandýr. Bu noktalar orijinden
büyük deðerler. 
