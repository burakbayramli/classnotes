...
$\sigma$ ifadeleri 1 veriyor. Eðer 1 veriyorsa eðri bitiþinde elimizde olan
$x$ deðeri $x = a_x + b_x + c_x + d_x + e_x$ olmalý. Optimizasyonda bu
eþitliðin belli bir deðer (istediðimiz bitiþ noktasý kordinatý) olmasýný
þart tutarsak amaca eriþmiþ oluruz.
