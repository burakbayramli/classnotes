...
noktasýnda iken, çizgi $Q_0$ üzerinde, tek birim adým atýldýðýnda ($t=1$) ise 
$Q_1$
...
formülü. Aslýnda formüle baktýðýmýz zaman t sýfýr deðeri için denklemin $Q_0$ 
noktasýný iþaret ettiðini görebiliyoruz. Bu deðer, bizim baþlangýç noktamýzdýr, 
ve t'nin pozitif veya negatif oluþuna göre pozitif veya negatif yönde 
ilerleyebiliriz.  Formülün parçalarý olan $x(t),y(t),z(t)$ sadece $t$'nin
fonksiyonudurlar, ve hep $t$ ile bir katsayýnýn çarpýmý, artý bir sabit
...
üzerinde deðil. Peki noktalar düzlemin hangi tarafýnda? Farklý tarafýnda,
çünkü biri $<7$, öteki $>7$ sonuç verdi. Bir düzlem uzayý iki yarý-parçaya 
ayýrýr ve noktalar bu ayrý parçalardadýrlar. Doðru cevap "Farklý tarafýnda"dýr. 
...
parametrik denklemler uzaydaki herhangi bir eðriyi, herhangi bir
hareketi, yolu temsil etme kabiliyetine de sahiptir. 

Genel baðlamda söylemek gerekirse, parametrik denklemleri bir uzayýn içindeki 
veya bir
düzlem üzerindeki herhangi bir hareketi temsil etmek için
kullanabiliriz.

Cycloid (Yuvarlanma Eðrisi)

$a$ yarý çapýndaki bir tekerlek yerde -x ekseninde- dönerek ilerliyor, $P$ bu
tekerleðin dýþ yüzeyinde bir noktadýr ve baþlangýç noktasý 0 üzerindedir. Bu 
durumda ne olur? Daha detaylý olarak sormak gerekirse, $P$ noktasýnýn hareketini
$t$'nin bir fonksiyonu $x(t),y(t)$ olarak ifade ebebilir miyiz?
...
baðlantýlý olduðuna göre, ayrýca problemdeki en çetrefilli, girift oluþturan 
hareket dönme hareketi olduðu için, belki de tekerleðin ne kadar döndüðünü 
gösteren
bir açý deðeri kullanýrsak belki daha faydalý olacak. Pek çok
...
tekerleðin dýþ çemberinin katettiði mesafe (üstte yeþil ile
...
eksik kalacak tek parça, basit toplamayla elde edebileceðimiz, aradýðýmýz
...
pek net sonuçlar deðiller. Demek ki bize daha iyi yaklaþým
teknikleri gerekiyor. 

Tek Deðiþkenli Kalkülüs dersinde bize Taylor yaklaþýmý öðretilir. 
...
Bir fonksiyon $f(x)$'in bir kuvvet serisi toplamý olduðunu
farzedelim [3, sf. 805], 
...
Ýþte Taylor yaklaþýmý budur! Ana formülü kaç polinom derecesi ile
