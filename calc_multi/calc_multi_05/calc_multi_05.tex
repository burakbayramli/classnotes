...
Þöyle bir yöntem daha iyi olmaz mýydý? Herhangi çizgi üzerinde bir nokta hayal edelim, ve bu noktanýn herhangi bir t(zaman) deðeri için bu çizgi üzerinde farklý bir konuma sahip olduðunu düþünelim. Herhangi bir t deðeri için, çizgi üzerindeki konumu bulabiliriz. Bu þekilde çizgi üzerindeki tüm noktalarýn konumlarýný tanýmlayabiliriz. Bu tür parametreye baðlý denklemlere -ki bu örneðimizde parametre t'dir- parametrik denklemler denir. 
...
noktasýnda iken, çizgi $Q_0$ üzerinde, tek birim adým atýldýðýnda ($t=1$) ise $Q_1$
üzerinde olsun. O zaman yarým birim zamanda denklemimiz iki noktanýn tam ortasýný iþaret eder. 
...
formülü. Aslýnda formüle baktýðýmýz zaman t sýfýr deðeri için denklemin $Q_0$ noktasýný iþaret ettiðini görebiliyoruz. Bu deðer, bizim baþlangýç noktamýzdýr, ve t'nin pozitif veya negatif oluþuna göre pozitif veya negatif yönde ilerleyebiliriz.  Formülün parçalarý olan $x(t),y(t),z(t)$ sadece $t$'nin
...
çünkü biri $<7$, öteki $>7$ sonuç verdi. Bir düzlem uzayý iki yarý-parçaya ayýrýr ve noktalar bu ayrý parçalardadýrlar. Doðru cevap "Farklý tarafýnda"dýr. 
...
Genel baðlamda söylemek gerekirse, parametrik denklemleri bir uzayýn içindeki veya bir
...
tekerleðin dýþ yüzeyinde bir noktadýr ve baþlangýç noktasý 0 üzerindedir. Bu durumda ne olur? Daha detaylý olarak sormak gerekirse, $P$ noktasýnýn hareketini
...
baðlantýlý olduðuna göre, ayrýca problemdeki en çetrefilli, girift oluþturan hareket dönme hareketi olduðu için, belki de tekerleðin ne kadar döndüðünü gösteren
...
Ayrýca modellemede parametre $t$ deðil, $\theta$. Bu mantýklý, çünkü deðiþimi ile
