...
hareket dönme hareketi (rotation) olduðu için, belki de tekerleðin ne kadar 
döndüðünü 
gösteren
...
teknikleri (approximation) gerekiyor. 
...
fonksiyonu belli bir noktada ($x=a$) yaklaþýksak olarak temsil
