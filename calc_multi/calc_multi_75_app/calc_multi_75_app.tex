...
diyelim, o zaman bir noktadaki birim zamandaki birim alandaki akış
$\rho v \cdot N$. Bu değeri $\Delta S_{ij}$ ile çarparsak $S$ üzerindeki
...
Izgara hücreleri $S_{ij}$ ufaldıkça üstteki toplam gerçek kütle akışına
yaklaşır, o zaman
