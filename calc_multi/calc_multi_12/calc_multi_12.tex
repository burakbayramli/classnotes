...
deðiþime ne kadar ``hassas'' ne kadar ``baðlý'' olduðunu gösteriyor.
...
kullanabileceðimizi incelemek. Gradyanlarý yaklaþýksak formüllerde
...
bile herhangi bir fonksiyonun birinci yaklaþýksaklýðý bir düzlem yaratýr, o
düzlemin normali, gradyaný eþitliði bizi yine gradyanýn dikliðine götürür. Ama
...
yani $\Delta w = 0$ ise. Bu arada üstteki yaklaþýksaklýðýn bir lineer
yaklaþýksaklýk olduðunu unutmayalým. $(2,1,1)$ noktasýnda bu teðeti kullanmak 
istersek,  
...
deðiþtiðini ölçerler. Peki baþka yönlere göre, mesela bir birim 
...
ilerliyorum, o zaman parametrize ettiðim þey kat edilen yol. $s$ bir anlamda
...
w||\cos(\theta)$ ifadesinin en büyük olduðu yer $\cos(\theta)=1$ olduðu
