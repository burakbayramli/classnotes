...
$<a_1,a_2,a_3>$. Bu vektörün gradyanla ayný çýktýðýna dikkat, ki normal
vektör de düzleme diktir zaten. Ayný çýkmalarý mantýklý. 
...
yaklaþýksallýk olduðunu unutmayalým. $(2,1,1)$ noktasýnda bu teðeti kullanmak 
istersek,  
