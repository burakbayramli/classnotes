...
RNN'lerin biraz daha farklý bir çeþidi LSTM. RNN'lerde içiçe geçen
fonksiyonlar sebebiyle hatalar ya çok büyüyüp ya da çok
küçülebiliyor. Gerçi bu normal derin YSA'lerde de problem olabilirdi, fakat
RNN'lerde bu durum daha belirgin, çünkü N adým geriye gitmek demek N kadar
içiçe geçen fonksiyon demektir, ve sýralý veriyi tahmin için N'in büyük
olmasý gerekebilir. LSTM hatayý sabit bir seviyede tutarak yeni bir
yaklaþým getirmiþ. Pür RNN'lerde de bazý çözümler getirildi tabii.
...
[2] Bayramli, {\em Derin Öðrenim ile Text Üretmek, RNN, LSTM}, \url{http://sayilarvekuramlar.blogspot.co.uk/2017/01/derin-ogrenim-ile-text-uretmek-rnn-lstm.html}
