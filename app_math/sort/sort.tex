...
hava kabarcýðý gibi üste doðru çýkmalarýndan geliyor (küçük olanlarýn yükselmesi
anlatým olarak daha iyi olurdu belki ama neyse).
...
Hýzlý Sýralama (Quicksort)

En ünlü ve hýzlý iþleyen sýralama algoritmasý Hýzlý Sýralama (HS). HS
böl-ve-ele-geçir (divide-and-conquer) usulü sýralama yöntemlerinden biridir. Bir
dizini alýr, ve iki parçaya (partition) böler, her parçayý ayrý ayrý
sýralar. Peki alt parçalarýn sýralamasý nasýl yapýlýr? HS'nin kendisiyle! Yani
bir özyineli çaðrý var.
