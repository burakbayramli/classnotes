...
Sigmoid seçiminin bir diðer sebebi türevinin rahat alýnabilmesi. Alternatif
fonksiyonlar $\tanh$ olabilirdi, ya da düzeltilmiþ lineer ünite (rectified
linear ünit -ReLu-) fonksiyonlarý. ReLu'lar YSA'larýn uzantýsý Derin
Öðrenim'de oldukca popüler oldu, tanýmý
...
seviyenin girdisi haline geliyor. YSA'lar takip edilen (supervised) þekilde
...
aðýrlýklarý ile çarpýlýyor. Bu aðýrlýklý toplama ve onun olduðu gizli
katmana ``tamamen baðlanmýþ katman (fully-connected layer)'' ismi de
veriliyor çünkü tüm girdi sinyalleri her gizli katman düðümüne hep beraber
giriþ yapýyorlar (gerçi farklý aðýrlýklar üzerinden). Devam edelim,
