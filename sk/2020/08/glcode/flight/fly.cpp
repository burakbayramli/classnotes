...
void keyboard(unsigned char key, int, int) {
  ...
  switch(key) {
    ...
    case 'r': newLandscape();
    case 't': theShip.roll(angle); break;
    case 'y': theShip.roll(-angle); break;
    case 'g': theShip.yaw(angle); break;
    case 'h': theShip.yaw(-angle); break;
    case 'v': theShip.pitch(-angle); break;
    case 'b': theShip.pitch(angle);  break;
  }
}
