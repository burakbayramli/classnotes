...
Ýlk pivot'tan baþlayalým (yeþil ile iþaretli)
...
$$ 
\left[\begin{array}{rrrr}
\textcolor{green}{1} & 2 & 0 & -2  \\
0 & 0 & \textcolor{green}{2} & 4 \\
0 & 0 & 0 & 0
\end{array}\right]
 $$

Yeni bir sýfýr elde etmiþ olduk (pivotlar yeþil ile iþaretli). Bu arada
