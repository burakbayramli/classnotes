...
O zaman Ýstatistik notlarýmýz altýndaki {\em Paralel Matris Çarpýmý, Ax,
QR ve SVD} yazýsýnda olduðu gibi $B$'nin SVD'sini alarak yaklaþýksal
bir $U$ elde etmek mümkün olacaktýr.
...
[4] Bayramlý, {\em SVD Factorization for Tall-and-Fat Matrices on Map/Reduce
