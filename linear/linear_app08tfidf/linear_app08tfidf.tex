...
Altta bu kavramlarýn kullanýmýný görüyoruz; daha önce {\em Ýstatistik, Naive
  Bayes} yazýsýnda kullandýðýmýz veriler bunlar, Barack Obama ve Stephen
Hawking'in yazdýklarýndan alýnan bölümler. Önce indeksleme, sonra bazý
kelimelerle arama yapýyoruz. Kelimeleri sayýsal bir kolon indisine çevirmek için
anahtarlama numarasý kullanýldý (ayný yazýda bundan da bahsediliyor); \verb!D!
kadar kolon tanýmlýyoruz, her kelime üzerinde bir hash sayýsý hesaplayýp
matematik modülosunu alýyoruz (bölümden arta kalan sayý) bu sayýyý kolon indisi
yapýyoruz. Böylece \verb!D!'den fazla kolon olamaz, ve her kelime hala ayný /
özgün kolona gider.
...
[1] Bayramli, {\em Dil Isleme, Python - NLTK}, \url{http://sayilarvekuramlar.blogspot.com/2016/04/dil-isleme-python-nltk.html}

[2] Manning, {\em Introduction to NLP, Lecture Notes}, \url{https://web.stanford.edu/~jurafsky/NLPCourseraSlides.html}

[3] Bayramli, {\em Scipy Seyrek Matrisleri (Sparse Matrices)}, \url{http://sayilarvekuramlar.blogspot.com/2016/04/scipy-seyrek-matrisler-sparse-matrices.html}
