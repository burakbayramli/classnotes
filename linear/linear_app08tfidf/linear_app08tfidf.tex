...
[1] Bayramlý, {\em Dil Isleme, Python - NLTK}, \url{http://sayilarvekuramlar.blogspot.com/2016/04/dil-isleme-python-nltk.html}

[2] Manning, {\em Introduction to NLP, Lecture Notes}, \url{https://web.stanford.edu/~jurafsky/NLPCourseraSlides.html}

[3] Bayramlý, {\em Scipy Seyrek Matrisleri (Sparse Matrices)}, \url{http://sayilarvekuramlar.blogspot.com/2016/04/scipy-seyrek-matrisler-sparse-matrices.html}
