...
Altgradyanlar aslýnda bir algoritma deðil, bir matematiksel kavram [1], ve hem
...
``eðer $f$'in türevi alýnabilir ise $g=\nabla f$'' açýklamasý ile
uyuyor. $x=0$ noktasý için birçok seçenek var, herhangi bir $[-1,1]$ öðesi
için, yani -1 ve +1 arasýndaki herhangi bir sayý olabilir, çizgili noktalar
seçeneklerden ikisi.
