...
operatörü deniyor. Üstteki optimalliðe uyan bir çözüm, hatta tek çözüm,
budur.
...
[distance to convex set ornegi atlandi]
...
$$
\frac{1}{2} || Ax - b||_2 + \lambda ||x||_1
$$

L1 normu $||x||_1$ gradyan iniþi için problemli o sebeple altgradyan metotu
kullanacaðýz. Veri olarak [5]'te gorulen diyabet verisini alabiliriz,
...
[5] Bayramli, {\em Istatistik, Regresyon, Ridge, Lasso, Çapraz Saðlama, Regülarize Etmek
