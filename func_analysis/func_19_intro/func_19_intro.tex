...
probleminde $f,g$ dýþbükey ve $h$ lineer (affine) olmalýdýr. $f,g$
üzerinden gösterilen þartlara uyan deðerler olurlu (feasible) deðerler
olarak bilinir.
...
Guzel. Top icinde olurlu bir noktam var, tanim kumesi icinde, $y$ de
orada. $f(y)$ hakkinda ne soyleyebilirim?

$$
f( t x + (1-t) z) 
$$

$f$ disbukey degil mi? O zaman usttekini disbukeylik uzerinden acarsam,
