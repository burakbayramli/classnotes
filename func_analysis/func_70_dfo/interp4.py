...
#res = minimize(fun=rosenbrock,x0=x0,method='trust-ncg',jac = Grad_interp, hess= Hessian_interp)
#res = minimize(fun=rosenbrock,x0=x0,method='trust-krylov',jac = Grad_interp, hess= Hessian_interp)
