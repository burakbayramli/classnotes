...
def f(u):
   return np.sum(np.power(u-xcor, 2)) + mu*norm_atv(u)
...
Yani $F(u)$ $u$'nun bilesenlerinin yaklasik L1 norm'unun toplamidir. Nihai
...
Eðer bir ileri farklýlýk matrisý $D$ tanýmlarsak, 
