...
hedefli bir halde konumlandýrmak [4], 
...
L1-norm'unun (tek boyutta mutlak deðer fonksiyonu) $x=0$'da türevi yoktur
(birinci terimdeki Oklit normunun karesi alýndýðý için onun iki kere türevi
alýnabilir). Bu durumda $\phi_{tv}$'yi yaklaþýk olarak temsil edebilirsek,
onun da türevi alýnýr hale gelmesi saðlayabiliriz. Bu yeni fonksiyona
$\phi_{atv}$ diyelim,
...
Buradan analitik olarak devam etmeden önce sayýsal olarak bir çözüme
bakalým. Üstteki fonksiyonlarý olduðu gibi kodlayarak sayýsal türev
alabilen bir kütüphane çaðrýsýyla hedefi minimize edelim, eldeki sinyal,
...
türevler Jacobian ve Hessian bulunabilir, ayrýca problemdeki matrislerde
muhtemel bir seyreklikten (sparsity) faydalanýlabilir.
