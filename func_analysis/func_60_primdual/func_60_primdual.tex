...
genelleþtirmek mümkün deðil, o sebeple bu derste önü iþlemedik. Ýç nokta
...
Tabii simplex bir baðlamda deðiþik bir mahluktur, ``direk yöntem'' denen
bir metot sýnýfýnda, þimdiye kadar gördüðümüz metotlarda olduðu gibi döngü
içinde daha iyi, daha iyi çözüme gitmiyor, en iyi, kesin çözümü bulmaya
uðraþýyor [tabii lineerlik burada faydalý herhalde, ayrýksal þekilde
seçenek arama açýsýndan, ama diðer yandan lineerlik ötesine geçilemiyor].
...
olarak çok kuvvetliydi ama pratikte ne yazýk ki böyle olmadýðýn görüldü,
...
Örnekle devam edelim. Bir LP'yi ana-çift yöntemi ve bariyer yöntemi ile
çözeceðiz ve farklarýna bakacaðýz. Standart form LP'nin KKT koþullarý, 
...
Sarþýma uðratýlmýþ KKT þartlarý, üstteki formülde tamamlayýcý gevþeklik için
eþitlike $1/t$ kullanarak  elde edilir,
...
Sonra ustteki tum esitlik sinirlamalarini aliyorum (esitsizlikleri dongu
sirasinda tatmin etmeye ugrasacagim) ve onlari bir matriste istifliyorum,
