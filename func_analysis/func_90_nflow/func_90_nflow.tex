...
deðeri). Bedel örneði olarakl mesela bir kenar \$2/birimlik olabilir diðeri
\$10/birim bedelinde olabilir. O zaman ilk kenardan 5 birim göndermek
istersem bunun bana bedeli \$10 ikincisinden gondermek istersem \$50
olacak. Her kenarýn akýþ bedeli, kapasitesi bizim dýþarýdan bir parametre
ile tanýmladýðýmýz bir þey olacak tabii ki. Kapasitenin illa sýnýrlanmýþ
olmasý gerekmez, sýnýrsýz da olabilir.
...
sýfýrdýr). Muhafaza denklemi, her düðüm $k$ için 
