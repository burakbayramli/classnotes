...
-\frac{1}{2} (c - u + A^Tv)^T Q^{-1}  (c - u + A^Tv) - b^Tv & 
  \textrm{eger } c - u + A^Tv \perp null(Q)\\
...
icin bir ikiz $g(u,v)$ olusturabiliriz ki her zaman $f^* \ge g(u,v)$
olacaktir her $u \ge 0$ ve $v$ icin. O zaman en iyi alt sinir $g(u,v)$'yi
{\em tum} olurlu $u,v$'ler uzerinden maksimize ederek elde edilir. Bu bize
...
alt gradyan (subgradient) metotlarýyla.. bir þekilde bu olur. Bilimin
...
Þimdi $\max$ basýndaki eksiye bakmadan geri kalanlara bakalým. $u,v$
...
Altta bir ornek sectim, oyle ki ikiz hesaplanabilir halde olacak, her ne
...
Sol grafikteki köyü siyah nokta ikizdeki maksimuma tekabül eden nokta,
