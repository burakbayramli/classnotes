...
olarak kodlayabilirim.

Bir diðer örneðe bakalým. Bu çok daha basit bir karesel program, iki
boyutlu. 

$$
\min_{x \in (x_1,x_2)} f(x) = \frac{1}{2} x^T Q x b^T x \quad \textrm{oyle ki}
$$
$$
x \ge 0
$$
...
da sýfýrda büyük, bu her iki ikiz deðiþkeni çözümde sýfýr olmaya zorluyor. 
