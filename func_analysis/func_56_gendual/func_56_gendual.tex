...
güçlü ikizlik var. Harfiyen ile tüm eþitlik þartlarý sýfýra eþit, tüm
eþitsizlikler sýfýrdan küçük olmalý. 

Çoðunlukla bu çok, çok zayýf bir þart, yani yerine getirmesi çok
kolay. Yani ana problemin dýþbükey olup da Slater þartýna uyulmamasý çok
...
Bir basit kavrama daha deginelim. Basit ama cok faydali olabilir, mesela
ana ve ikizi optimize etmek ici bir ozyineli algoritma gelistiriyorsunuz,
...
geliþtirirken ``optimal kritere ne kadar yakýným?'' diye merak ediyoruz,
...
içi de geçerli, ondan da 0.001'den daha uzakta olamayýz, $g^*-g(u,v)$ ayný
...
$\epsilon$ alt optimal sonucu elde etmiþizdir. 
