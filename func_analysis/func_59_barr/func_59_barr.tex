...
Eðer problemim $\min c^T x$ öyle ki $D x \le e$ olsaydý,

\includegraphics[width=20em]{func_59_barr_01.png}

Sýnýrlar görülüyor, baþlangýç o sýnýrlarýn ortasýnda diyelim, ufak $t$
olduðu zaman oradayým, çünkü sýnýrlar kuvvetli þekilde bizi her taraftan
itiyor. Nihai sonuç $x^*$ iki sýnýrýn kesiþtiði yerde görülüyor. 
$t$'yi arttýrdýkça $f$'nin önemi artacak, ve sonuca yaklaþacaðýz.
...
Geri kalanlar, Lagrangian üzerinden 
...
Gradyan kullanmak yeterli çünkü tüm fonksiyonlar dýþbükey ve pürüzsüz. 

Üstteki problemi bazý herhangi bir $w$ için çözebilirsem o zaman merkezi
gidiþ yolundaki bir çözümü her $t$ için karakterize etmiþ oldum. Umudumuz o
ki $t$'yi sonsuzluða doðru iterken gördüðümüz KKT koþullarýnýn ima ettiði
...
fonksiyonuna yaklaþacaktýr, o zaman optimizasyonu yaparken $t$'yi
büyüttükçe orijinal problemin gerçek sonucuna yaklaþmýþ olalým. 
