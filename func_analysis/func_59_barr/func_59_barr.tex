...
Ama simdi ustteki problem icin nasil baslangic degeri buluruz sorusu var,
ama bu daha basit. $Ax^0 = b$'ye cozum olan herhangi bir $x^0$'yu aliriz,
ve $t^0 = 2 - \min_i x_i^0$ seceriz. Tabii eger $\min_i x_i^0 < 0$ degil
ise, yani tum $x_i$'lar pozitif ise, o zaman is bitti demektir, $x^0$ zaten
harfiyen olurlu ve isimiz bitti. 
