...
yerine getirilemediðini bize söyler. Dezavantaj, üstteki çözmesinin biraz
daha zor olabilmesi.
...
Standard LP çözen bariyer metot temelli kod alttadýr [3]. 

Not: Bu metot baþlangýç noktasý bulmak için
...
LP'si üzerinde bu programý iþlettik.
