...
Ý)'' ismi veriyor, problemin kendisini çözmeye ``2. Faz'' diyor. Pratikte
...
büyüðünü artý mesela 0.01 diyerek kullanmak [2, 24:00]. Elde ettiðimiz
...
anda sak diye durabilirim, yani üstteki programýn ``optimal'' olmasýyla
ilgilenmiyorum sonuçta bana tek gereken ana problemim için olurlu bir
baþlangýç noktasý. 

Çoðunlukla yapýlan tarif edilen þekilde $x,s$ bulmak ve bunu ardý ardýna
yapmak ta ki tamamen negatif elde edilene kadar ve o noktada durulur, ana
probleme dönülür. 
...
Standard LP cozen bariyer metot temelli kod alttadir [3],
