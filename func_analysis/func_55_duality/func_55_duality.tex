...
\includegraphics[width=20em]{func_55_duality_01.png}
...
noktasý $s$ bitiþi noktasý $t$'ye maksimum miktarda nakil edebilecek yolu
...
O zaman maksimum akisi bir LP olarak kodlayalim,
...
sebeple optimizasyonu tek bir toplam ile tanýmlayabildik. Ustteki grafik
ornekte goruluyor, çýkýþ toplam 3+2+1 varis toplam 4+2.
