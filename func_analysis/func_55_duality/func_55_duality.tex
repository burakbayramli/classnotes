...
En sagdaki ifadeyi $g(u,v)$ olarak yazabiliriz, $u,v$'nin bir
fonksiyonu olarak. Bu fonksiyon $f^*$'ye bir alt sinir saglar, 
...
Ama $c^T + A^Tu + G^T v$ sifir ise o zaman minimum nedir? Sifirdan geri
