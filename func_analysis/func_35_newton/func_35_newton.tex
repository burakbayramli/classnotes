...
kolay midir? Sisteme göre deðiþir, 100 x 100 sistem, problem yok. 10,000 x
...
Dikkat edilirse þimdiye kadar diþbukeylik (convexity) farzýný yapmadýk,
...
noktadayým. Newton-imsi metotlarda bu yeni noktada sil baþtan bir Hessian
iþlemek yerine bir önceki adýmdaki iþlenen Hessian sonuçlarýný, bir
þekilde, az ek iþlem yaparak sonraki adýmda kullanmaya uðraþýyorlardý.
