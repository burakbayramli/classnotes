...
gradyan $2Ax$ sonucunu veriyordu, o zaman ucuncu terimde $H$ kalir, 2 ve
$1/2$ birbirini iptal eder, sonuc

$$
\nabla h() = \nabla f(\bar{x}) + H(\bar{x})(x-\bar{x})
$$

Iki ustteki karesel yaklasiksal ifadenin gradyani bu iste. Onu sifira
esitleriz ve cozeriz, 
