...
Iz surme yontemi adim buyuklugu $t$'yi hesaplamak icin kullanilir, pur
metot $t=1$ kullaniyor tabii ki.  Arama algoritmasi iki parametreyi baz
alir, $\alpha,\beta$. Bu parametreler icin iyi isleyen bazi degerler mesela 
$0 < \alpha <1/2$ ve $0 < \beta < 1$. Her adimda $t=1$ ile baslariz, ve
...
\begin{itemize}
   \item Bellek: her adýmda Newton yöntemi $O(^2)$ yer tutar, çünkü
...
[7], Boyd, {\em Convex Optimization I, Lecture 16}
