...
mi? $x$'e göre Lagrangian'ýn altgradyanýný aldým ve bu sýfýra eþit. 
...
altgradyani yazmak basittir. Sonucu bulmak her zaman kolay olmayabilir ama
en azýndan duraðanlýðý formülize etmek kolaydýr. Fakat bazý fonksiyonlarda
dýþbükeylýk yoksa altgradyanlarý hesaplamanýn zorluðu ötesinde bazen
...
dalgýnlýkla bunu söyleyebiliyorum bazen. Fonksiyon var, altgradyanini alýp
sýfýra eþitliyorum, bu ``KKT koþulu'' diyorum. Bu doðru tabii, sadece
KKT'nin çok basit bir hali. 

Ornek

Eþitlik þartlarý olan karesel bir fonksiyounun minimizasyonuna bakalým. 

$$
\min_x \frac{1}{2} x^T Q x + c^T x \quad \textrm{oyle ki}
$$
$$
Ax = 0
$$
...
Duraðanlýk için üsttekinin gradyanini alýp sýfýra eþitlerim, 
...
Guzel degil mi? Hatta bu lineer bir sistem olarak yazilabilir,
