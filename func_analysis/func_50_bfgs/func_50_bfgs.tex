...
O zaman iki üstteki denklemle beraber, ve açýlýmda $x$ herhangi bir $x$
olabileceði için onun yerine $x^k$ kullanarak,
...
Ne yazik ki kerte 1 guncelemesinin bazi problemleri var. Bunlardan en
onemlisi 
