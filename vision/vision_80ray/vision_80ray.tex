...
hesaplayabiliriz belki. 

Mesela alttaki resimdeki kýrmýzý piksellerin mesafesini bulmak
istiyorum. Problem öyle ki bu piksellerin yolu temsil eden pikseller
olduðunu biliyorum. Bu bilgiyi nasýl elde ettim? Renksel bazlý, ya da iki
boyutta imajý parçalara bölmeyi çok iyi yapan bir algoritmam var, vs. Þimdi
bu bilgi bana bir þey kazandýrdý: üç boyutta bu piksellerin hangi düzlemden
geldiðini biliyorum artýk. Bu düzlem $x-y$ düzlemi, düzlem üzerinde $z=0$. 
...
Þimdi bir numara daha: bir piksele bakarak onun kesin üç boyutlu yerini
...
dünyadaki bir $X_1$ noktasýna doðru gidiyor. 

Þimdi bu iki fikri biraraya koyarsak, elde bir düzlem, bir iþin var; eh
ikisinin kesiþtiði yer yol noktasýnýn üç boyutlu kordinatýdýr.
