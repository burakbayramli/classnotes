...
Bir ýþýn hesabý yapalým. Bir önceki resimde $p_1$'e benzeyen bir nokta iki
üstteki resimde mavi renkli gösterildi. Bu pikselin ýþýný neye benzer?
...
bir normal) arasýnda kesiþmeyi hesaplayan çaðrýdýr. Üstteki gördüðümüz
kýrmýzý noktalý pikselleri alýp, onlarýn ýþýný bulacaðýz, sonra o ýþýnýn
$xy$ düzlemi ile kesiþmesini bulacaðýz. Kamera matrisi $K$'yi biliyoruz,
çünkü kamerayý biz kalibre ettik, detaylar için [2].
