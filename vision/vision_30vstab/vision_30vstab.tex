...
Dönüþ $R$, taþýnma $t$, ölçekleme $s$. Bu transformasyona ölçeklemeye
(scaling) izin veren bir katý (rigid) transformasyon deniyor. ``Katý''
demek $s=1$ ile noktalar arasý mesafeler deðiþmeyecek demek, $s$ ile tabii
ölçekleme olabilir, mesafeler artabilir, ama mesafe oranlarý yine ayný
kalýr, ayrýca döndürme de -rotation- yapýlabilir. Bu transformasyona
yansýtsal (projective) ismi de verilir. Yansýtal transformasyonun ýlgýn
transformasyondan daha esnek / kuvvetli olduðu bilinir.
...
Yansýtsal $H$ hesabý için direk lýneer transform (direct linear transform
