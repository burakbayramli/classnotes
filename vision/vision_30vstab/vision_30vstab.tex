...
çözüm þaþýrtýcý derecede basit. [4]'teki çözüm þöyle özetlenebilir: bir
...
resimdeki eþlerini elde ederiz. Tüm eþlemeleri kullanarak bir
transformasyon hesaplarýz, bu transformasyon matrisý içinde $x,y$ deðiþimi,
yani taþýmma, ve $a$ acýsý ki döndürme bilgisi vardýr. Bu bilgileri
$dx,dy,da$ olarak biriktiririz. Tüm kareler iþlenince deðiþimlerin
kumulatif toplamýný alarak $x,y,a$ zaman serilerini oluþtururuz. Bu zaman
serileri üzerinde bir yürüyen ortalama (moving average) hesabý yaparýz, bu
bize pürüzüþleþtirilmiþ zaman serileri verir. Þimdi kumulatif serinin
pürüzsüz þeriden olan farklarýný buluruz, ve her zaman anýnda bu farký alýp
bir önceki kare üzerinde yamultma yaparak onu ``düzeltiriz''. 

Kabaca tarif etmek gerekirse üstte gösterdiðimiz türde video'larda
"beklenen" bir nokta eþleþmesi var, düz yürüyoruz, kamera ileri dönük,
ortadaki pikseller dýþa doðru eþleþmeli, saðdakiler daha saða doðru, vs.,
bu beklenti hareketli ortalama ile hesaplanýyor, ve ondan olan sapmalarda
kameranýn istenmeyen titremesi olarak algýlanýyor.
