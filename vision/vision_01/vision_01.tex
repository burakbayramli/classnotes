...
(detaylar için {\em Fonksiyonel Analiz} notlarý). Her ölçek uzayý noktasal
çarpým üzerinden yaratýlmayabilir, mesela bir ezber tablo üzerinde bile bir
mesafe eþlemesi yaratýrdým, bu bir tür ölçev olurdu, ama bu ölçev
noktasal çarpým olmadýðý için ortaya bir Hilbert Uzayý çýkmazdý. 
...
þey. Daha fazla detay için {\em Lineer Cebir} notlarý.
