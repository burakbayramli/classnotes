...
günü ile yýldýz günü arasýnda 4 dakikalýk bir fark olabilir. Yýldýz günü
için Jülyen Tarihi kullanýlýr, iki an arasýndaki zaman farký Jülyen tarih
farklarý olarak hesaplanýr. Bizim bazý ölçümler aldýðýmýz zamaný milisaniye
olarak kaydettik, onun Jülyen çevrimi de hesaplandý,
...
Azimut, yükseklik hesaplarý için [1]'den ölçüm aldýðýmýz anda uydularýn
nerede olduðunu bir dosyaya kaydettik. GPS uydularý PRN kodlarý ile takip
edilir, PRN 11,18,16,24,31 için uydu enlem / boylam pozisyonlarý altta
bulunabilir,
...
Ölçüm alýnan yerin kordinatlarý Berlin'de altta \verb!lat,lon!
içinde. Þimdi bu noktadan bakýlacak olsa uydularýn hangi azimut,
yükseklikte olacaðýnýn hesabýný yapalým,
...
ters yönde çýkmýþ. Telefondaki ölçümlere tam güvenilir diyemeyiz. Peki
acaba elde yeteri kadar azimut, yükseklik ölçümü olsa ve uydu pozisyonu ile
birleþtirince üstteki hesapta geriye doðru giderek bir alýcý pozisyonu elde
edilebilir mi? Ýstatistiki bir yaklaþým belki bunu yapabilir. Ödev olsun!
...
Ayni zamanda bir GPS alicisi olan akilli cep telefonlari GPS uydularina
olan mesafeyi hesaplayabilir. Bunu uydudan gonderilen sinyallerin erisim
suresini hesaplayarak yaparlar. 
