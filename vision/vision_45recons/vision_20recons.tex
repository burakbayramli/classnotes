...
Aslýnda $F$ hesabý için 8 nokta yeterli, fakat daha fazlasýna da izin veren
bir çözüm yöntemi SVD ile mümkün. Çözülecek sistem eþkutupsal kýsýtlamadan
formülünden baþlar, her $i=1,2,..$ için $x_1^i,x_2^i$ eþleþmeleri olsun, o
zaman her $x_1^i F x_2^i = 0$'i içinde barýndýran bir $Af = 0$ sistemi
...
satýrda eskutupsal kýsýtlamayý elde edebileceðimizi görebiliriz. $Af = 0$
...
Üstteki hesap fena deðildir, fakat $F$ gibi kritik bir hesap için daha
saðlam bir yaklaþým tercih ediliyor. RANSAC adý verilen yaklaþýmla verilen
tüm eþleþme noktalarýndan ufak örneklemler toplanýr, her örneklem üzerinde
üstteki hesap uygulanýr, ve elde edilen sonuçlara bakýlarak gerçek $F$'e
yaklaþýp yaklaþýlmadýðý kararlarlaþtýrýlmaya çalýþýlýr. Detaylar için [1,
sf. 291]. 

OpenCV \verb!cv2.findFundamentalMat! çaðrýsýyla $F$'yi RANSAC ile
hesaplayabilir. Ardindan $E$'yi hesaplarýz, ve $E$'yi $R,t$ parçalarýna
ayýrýrýz. 
