...
O zaman bu iki matrisi birleþtirebiliriz, $K = K_sK_f$, ki $K$'ye iç parametre
...
$K$ matrisi iç parametreler ise, dýþ parametreler $g$ içinde. Bir kamerayý
hareket ettirdiðimizde iç parametreleri ayný kalacak, dýþ parametreler 6
serbestlik derecesi üzerinden deðiþecek.
...
Not: Bazý görüntü dosyalarýnýn içinde iç parametreler kaydedilmiþ olabiliyor bu
arada, Ýnternet'ten bir sürü resim indirip 3D tekrar oluþturma yapmak istenirse
bunu akýlda tutmak faydalý.
