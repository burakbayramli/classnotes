...
Bu yazýda mesafeleri kullanýp nerede olduðumüz konusuna girmeden, ondan
önce eðer nerede olduðumüz biliniyor olsa uyduya olan yatay açý / azimut
(azimuth) açý ve yüksekliði (elevation) nasýl buluruz konusunu iþleyeceðiz.

Azimut ve yatay açý nedir? Yeryüzünde duruyoruz, yüzümüzü kuzeye dönelim,
bu referans duruþu. Eðer mesela azimut 324 derece ise, doðuya doðru o kadar
döneriz (ya da batýya 360-324 kadar dönebiliriz, farketmez), ve baþýmýzý
yukarý doðru yükseklik açýsý kadar kaldýrýrýz, mesela 67 ise 67 derece
yukarý doðru, ki 90 derece tam dik yukarý bakýyoruz demektir. Aþaðý yukarý
alttaki resimdeki gibi bir durum olur, 
...
sat_lon = -164.259351
sat_lat = 30.518234
az,el,r = get_observer_look(sat_lon, sat_lat, sat_alt, dt, lon, lat, alt)
print '11', az, el, r
sat_lon = -57.092297
sat_lat = 1.027207
az,el,r = get_observer_look(sat_lon, sat_lat, sat_alt, dt, lon, lat, alt)
