...
def travel(lat, lon, bearing, distance):
    # yon (bearing) alttaki kodun orijinal halinde y-ekseninden
    # saat yonune dogru olan aci olarak aliniyordu. Biz bunu
    # ustteki argumanda x-eksenden saat yonu tersi olacak sekilde
    # kabul ediyoruz, ki tanidik matematik formulleri kullanilabilsin.
    brng = 3*np.pi/4 -  bearing
    #brng = bearing
    # mesafe kilometre
...
Bilinen bir baþlangýç noktasýndan 30 derece doðuya 30 metre gitmek, 

\begin{minted}[fontsize=\footnotesize]{python}
mf = 'berlin_52_5009766667_13_312235.png'
ref = [52.502035, 13.312638]
plot_line_gm(mf, [ref, travel(ref[0], ref[1], np.deg2rad(30), 0.030)], 'ku1.png')
\end{minted}

\includegraphics[width=25em]{ku1.png}

Þimdi toplanan veriye gelelim. Bu veride üstteki baþlangýç noktasýndan önce
doðuya yaklaþýk 30 metre sonra güneye doðru 100 metre kadar yürüdük,
