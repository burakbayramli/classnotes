...
Numerik olarak (mesela Euler yöntemiyle) bu denklemi çözmek ne demektir? Alttaki
çizime bakalým, $y_0$'dan deðerinden baþlýyoruz, bu noktada $x_0,y_0$
noktasýndaki eðimi $y'$ ile hesaplýyoruz, ve bu eðim bize $y$'nin olacaðý bir
sonraki yeri söylüyor. Bu eðim ile yukarý ya da aþaðý çýkýyoruz, ve bunu devam
...
Numerik Yöntemlerde Bazý Tehlikeli Noktalar
...
(bkz. {\em Bilgisayar Bilim, Yapay Zeka, Otomatik Türev Almak} yazýsý) bu
türevler rahatlýkla alýnabilir. Altta gösterme amaçlý olarak sembolik
alýnabilen türevli ODE gösteriyoruz.
