...
Yukarýdaki gibi bir formülü çözmek için, sýnavlardan hatýrlayabileceðimiz
...
ediyoruz. Bu tahmin etrafýnda fonksiyonun Taylor açýlýmý [1, sf. 175],
...
ki $x_i$ $N$ boyutlu bir vektör, ve $J$ Jacobian matrisi
...
içinde devam edilir. Parçalar $\log$ hýzýnda küçülecekleri için bu arama
oldukca hýzlýdýr. 
...
[1] Crighton, {\em Numerical Methods}
