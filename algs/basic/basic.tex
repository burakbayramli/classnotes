...
Programlama dillerinin çoðunda bölec kabiliyeti vardýr;
...
\verb!dfs!'in kendisini çaðýrýrsak derinleme dalýþ yapmýþ oluruz. Tabii bu
durumda gidilen yolu hatirlamak icin onu bir liste olarak surekli bir
sonraki ozyineli cagriya geceriz ve her cagridan geri donduruz. 
...
Önce geniþliðine arama yapmak için yiðit veri yapýsý yerine kuyruk
kullanmak yeterli. Bu durumda komþularý kuyruða koyduðumuz zaman o
komþularýn iþlenmesi bitmeden sonraki düðümlere geçilmeyecektir (çünkü
kuyruða ilk konan ilk önce iþlenir) bu ziyareti seviye seviye iþlem yapmaya
zorlar. 
...
\verb!_printPreorder! bu özelliði gösteriyor. 
...
Biraz daha kapsamlý bir kodlamayý altta görebiliriz, bu önemsel kuyruða
anahtar / deðerler veriliyor, anahtar deðerleri mesela araba modelleri,
önem ise fiyatlarý olabilir, ve deðerler çekildiðinde deðeri en az (önemi
en fazla) olan deðer çekilecektir. Ayrýca bu kuyruðu bir döngüyle ``gezmek''
kuyruktan deðerlerin çekilmesini de saðlýyor. Kuyruðun iç kodlamasýnda
kullandýðý temel yapý ikisel yýðýn (binary heap) adlý bir yapýdýr.
