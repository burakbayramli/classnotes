...
salinip, ayrý ayrý onlara fiziksel kurallar uygulanýr ve nereye geldiklerine
bakýlýr. Bu hesap sýrasýnda objelerin birbirine çarpýp çarpmadýðýný hesaplamak
gerekir. Ama bu, eðer mesela $n$ tane obje var ise, her görüntü karesinde her
$n$ tane objenin her $n-1$ diðer objenin yakýnýnda olup olmadýðýnýn hesabý
demektir, ki bu hesapsal yük olarak $O(n^2)$ olur. Eðer $n$ milyonlar ise bu
aðýr bir yük demek olacaktýr.

Bölec tekniðini burada da kullanabiliriz, yani, mesela öyle bir sihirli bölec
fonksiyonumuz olsaydý ki her kordinat için bir bölec deðeri üretseydi ve
birbirine yakýn kordinatlar için bu deðer ayný olsaydý böylece basit eþitlik
kontrolü ile iki kordinatýn birbirine yakýn olup olmadýðýný anlasaydýk? Tabii
daha detaylý kontrol için bu yakýnlýk testinden geçen kordinatlarý daha detaylý
test tabi tutardýk ama detaylý kontrolün yapýlacaðý obje sayýsýný çok daha
azaltmýþ olurduk.

Böyle bir tekniði [4]'te görüyoruz. Teknik kordinate sistemini $l$ büyüklüðünde
kutulara bölüyor, bölüm sonrasý elde edilen sayýyý taban (floor) tamsayýya
indirgiyoruz, ardýndan her eksen için farklý bir asal sayýyla çarpýp sonuçlarý
XOR ile birleþtiriyoruz (ki XOR yaygýn kullanýlan bir bölec birleþtirme
yaklaþýmý).
...
Görüldüðü gibi ilk iki kordinat ayný bölec anahtarýna düþtü, ki bu kordinatlar
birbirine yakýn.
