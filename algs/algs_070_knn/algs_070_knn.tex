...
kontrolü anlamýna gelir, ki hesapsal yük $O(n^2)$ olurdu. Eðer $n$ milyonlar ise
bu aðýr bir yük oluþtururdu.

Böleç tekniðini burada da kullanabiliriz. Öyle bir sihirli böleç fonksiyonumuz
olsun ki her kordinat için bir böleç deðeri üretsin ve birbirine yakýn
kordinatlar için bu deðer ayný olsun. Böylece basit eþitlik kontrolü ile iki
...
Böyle bir tekniði [4]'te görüyoruz. Teknik ile kordinat sistemini $l$
büyüklüðünde kutulara bölüyor, her eksen deðerini bu büyüklük ile bölüyoruz,
bölüm sonrasý elde edilen sayýyý taban (floor) tamsayýya indirgiyoruz, ardýndan
her eksen için farklý bir asal sayýyla çarpýp sonuçlarý XOR ile birleþtiriyoruz
(ki XOR yaygýn kullanýlan bir böleç birleþtirme yaklaþýmý).
...
ilk fazda tüm objelerin kordinat böleci hesaplanýr, her böleç deðeri altýnda bir
...
C++ bazlý bir kod \verb!CompactNSearch! dizininde. 
