...
bir tahtayý girdi olarak alýp, yapýlabilecek tüm hamleler bir kazanç
...
Üçüncü ilerleme ise AGZ'nin kendisine karþý oynayarak kendini
eðitmesi. DeepMind bilimcileri araþtýrmalarý sýrasýnda þunu anladýlar:
hangi baz mimariyle baþlarsak baþlayalým, MCTS onu daha iyileþtirir. Bu
durumda herhangi bir YZ alýnýr ki baþta aðýrlýk deðerleri rasgele yani hiç
bir doðru karar vermez, bu YZ MCTS ile daha iyi performans gösterecektir,
bu sýrada oyundan eðitim verisi toplanýr ve bu veri YZ'yi iyileþtirmek için
aða uygulanýr, ve iþlem baþa dönerek devam edilir. Bu sayede en kötü
performanstan en iyisine doðru ilerlemek mümkündür.
...
\begin{verbatim}
Tensor("input_4:0", shape=(?, 17, 9, 9), dtype=float32)
...
Tensor("conv2d_48/BiasAdd:0", shape=(?, 17, 9, 32), dtype=float32)
Tensor("batch_normalization_48/batchnorm/add_1:0", shape=(?, 17, 9, 32), dtype=float32)
------------- value -------------------
Tensor("conv2d_49/BiasAdd:0", shape=(?, 17, 9, 2), dtype=float32)
Tensor("activation_58/Relu:0", shape=(?, 17, 9, 2), dtype=float32)
Tensor("flatten_7/Reshape:0", shape=(?, 306), dtype=float32)
policy_output Tensor("activation_59/Softmax:0", shape=(?, 82), dtype=float32)
------------- policy -------------------
Tensor("conv2d_50/BiasAdd:0", shape=(?, 17, 9, 1), dtype=float32)
Tensor("activation_60/Relu:0", shape=(?, 17, 9, 1), dtype=float32)
Tensor("flatten_8/Reshape:0", shape=(?, 153), dtype=float32)
Tensor("dense_11/BiasAdd:0", shape=(?, 256), dtype=float32)
Tensor("activation_61/Relu:0", shape=(?, 256), dtype=float32)
Tensor("dense_12/BiasAdd:0", shape=(?, 1), dtype=float32)
Tensor("dense_12/BiasAdd:0", shape=(?, 1), dtype=float32)
Out[1]: <tensorflow.python.keras._impl.keras.engine.training.Model at 0x7f95d7088c10>
\end{verbatim}

Bu mimari birkaç saat eðitim sonrasý GnuGo baþlangýç seviyelerini
yeniyor. Okuyucuya ödev, grafik kartlý güçlü bir mimaride \verb!resnet.py!
ile ve \verb!n_play!'i arttýrýp daha fazla simülasyon yaparak sonuçlara
bakmak olabilir.
...
[1] Bayramli, {\em Go Oyunu, GnuGo}, \url{http://sayilarvekuramlar.blogspot.com/2018/02/go-gnugo.html}
...
[6] Kristiadi, \url{https://wiseodd.github.io/techblog/2016/10/13/residual-net/}
