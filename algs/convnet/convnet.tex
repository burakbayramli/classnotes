...
iþlemi bir evriþim operasyonudur. Mesela 2 x 2 boyutlu bir filtre matrisini
tüm veri üzerinde kaydýrýrýz, her kaydýrma sýrasýnda o bölgede filtre
matrisini bölgedeki deðerleri ile çarparýz, sonucu hatýrlarýz, böylece yeni
bir matris yaratýrýz. Görüntü iþlemede çizgileri ortaya çýkartan / bulan
türden bilinen filtreler vardýr, vs.  Fakat derin ogrenim bu evrisim
matrisinin icerigini de ogrenir! Cunku eger cizgileri ortaya cikartmak
ogrenme isleminin butunune fayda getiriyorsa ogrenme sureci sirasinda
evrisim matrisinin degerleri o degerlere dogru gidecektir. Bu ek'in
convnet'in alt katmanlarýndaki hata düzeltme iþlemini daha rahatlaþtýrdýðý
keþfedildi. 

Bir diðer tur katman özel bir ReLu (doðrultan lineer ünite -rectified
linear ünit-) katmaný eklemek, bir diðeri ``aþaðý örnekleme
(downsampling)'' yapmak, mesela $2 \times 2$ içindeki bir pencere içine
düþen öðelerin maksimumunu almak, vs. Bir diðer katman ``veri atma
(dropout)'' katmaný, veri içinde bir kýsým rasgele þekilde eðitim
verisinden atýlýyor, böylece modelde aþýrý uygunluk (överfitting)
problemlerinden kaçýnýlmýþ olunuyor, potansiyel olarak daha saðlam (robüst)
