...
\begin{document}
Üretici Haþimsal Aðlar (Generative Adverserial Networks -GAN-)
...
olan YSA'nýn eðitim sýrasýnda bu tür gürültü farklarýna hassas hale gelmesidir!
...
edersek MNÝST baðlamýnda mesela bu tabandan gelen 0,1,2,. gibi etiketleri
kullanmýyoruz, etiketleri kendimiz üretiyoruz. 

\includegraphics[width=20em]{gan_07.png}

Amaç üretecin o kadar iyi hale gelmesi ki ayýrtaç gerçek imaj ile hayali olaný
...
Bu çýktýlarýn görüntüsü ilginç deðil mi? 
