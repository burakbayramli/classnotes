...
kadar oynayýp RL teknikleri bir oyuu oynamayý öðrenebilir.

Daha önce {\em Yapay Zeka ve Müsabaka} yazýsýnda farklý bir yaklaþým
gördük, bir deðer fonksiyonu vardý, bu fonksiyona tahtanýn son halini
...
pozisyonlarý bu fonksiyon ile deðerlendirerek ve arama yaparak
buluyordu. Fakat deðer fonksiyonu yaklaþýmýnýn bazý dezavantajlarý var,
birincisi fonksiyonun deterministik olmasý. Oyun sýrasýnda deðiþmiyor,
önceden kodlanmýþ.
...
problemine bakalým [1], kuruluþ, oyun açýklamasý için [3]. Bir simülasyon
