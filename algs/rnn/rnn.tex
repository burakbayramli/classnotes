...
etkilerler, fakat illa etiket / düzeltme baðlamýnda direk kullanýlmalarý
þart deðildir. Mesela bir RNN'e bir veri dizisi verip, çýktýlarýnýn en
sonuncusu hariç geri kalanlarýný yok sayabiliriz, bu bir dizi-vektör RNN'i
olur. Mesela RNN'e bir film hakkýndaki tüm yorumlarý kelime kelime veri
dizisi olarak verebiliriz, RNN çýktýsý -1/+1 þeklinde beðendi / beðenmedi
skoru olabilir. Altta diyagramý görüyoruz, 
...
durumda $y_1,y_2,..$ yerine $x_2,x_3,..$ serisi olacaktýr. 
...
verisinden pek çok olacak, ki bu veriler ufak toptan set (minibatch)
verimiz. Alttaki ufak veride 4 tane bu tür 2-2 veriler var.
...
Tabii bu bir eðitim deðil, RNN'e ileri yönde hesap yaptýrdýk, dört kez
...
isteseydik, bu çizit çok daha büyük olurdu. Büyük RNN durumlarý için TF'in
özel çaðrýlarý var, mesela \verb!static_rnn!. 
