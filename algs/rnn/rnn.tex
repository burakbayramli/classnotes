...
verisinden pek çok olacak, ki bu veriler ufak toptan eðitim (minibatch)
verimiz. Alttaki ufak toptan eðitim verisinde 4 tane bu tür 2-2 veriler
var. 

\begin{minted}[fontsize=\footnotesize]{python}
import numpy as np

# ufak toptan egitim seti
