...
layer3 = tf.layers.conv1d(inputs=layer2, filters=16,kernel_size=3,strides=1,padding='same')
...
layer4 = tf.layers.conv1d(inputs=layer3, filters=16,kernel_size=3,strides=1,padding='same')
