...
\inputminted[fontsize=\footnotesize]{python}{model2.py}
...
Tensor("stft/rfft:0", shape=(?, 124, 129), dtype=complex64)
Tensor("Abs:0", shape=(?, 124, 129), dtype=float32)
(<tf.Tensor 'bidirectional_rnn/fw/fw/transpose:0' shape=(?, 124, 200) dtype=float32>, <tf.Tensor 'ReverseV2:0' shape=(?, 124, 200) dtype=float32>)
(<tf.Tensor 'bidirectional_rnn/fw/fw/while/Exit_2:0' shape=(?, 200) dtype=float32>, <tf.Tensor 'bidirectional_rnn/bw/bw/while/Exit_2:0' shape=(?, 200) dtype=float32>)
Tensor("concat:0", shape=(?, 400), dtype=float32)
Tensor("fully_connected/BiasAdd:0", shape=(?, 4), dtype=float32)
\end{verbatim}
