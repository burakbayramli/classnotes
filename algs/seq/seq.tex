...
yaklaþým kullanarak kodlamýþ, fakat 2017 yýlýnda bu servisi tamamen derin
...
farklý boyutlarýn karýþýklýk yaratmýyor, çünkü tercüme için önemli olan þey
kodlayýcý bloktan kod çözücü bloða geçen gizli konum.

Bu konuma daha önceki yazýlarda $h$ adý vermiþtik. Tüm süreç þöyle, eðitim
için tüm cümleler + tüm kelimeler üzerinden bir sözlük oluþtururuz, bu
sözlüðe göre her kelimeye bir tam sayý indis deðeri atarýz, sonra
kelimeleri tam sayýlara çevirip gömme tabakasýna veririz, bu tabaka reel
sayý içeren vektörlere dönüþür, ve eðitim ilerledikçe referans gömme
matrisinde kelimelerin temsil deðerleri iyileþir. Bunlar otomatik oluyor
tabii, biz soldan saða YSA'ya her eðitim veri noktasýndaki kelimeleri teker
teker geçiyoruz, bir eðitim noktasý için önce birinci kelimeyi ilk RNN
öðesine, oradan çýkan $h$'yi ve ikinci kelimeyi ikinci RNN öðesine, böyle
devam ediyor.  
...
deðildir ama zaman geçtikçe öyle olacaktýr. Boyutu önceden planlanan
þekildedir, yani cümleye göre küçülüp büyüyen bir þey deðildir. Neyse tabii
ileri besleme orada durmuyor, kod çözücüye devam ediliyor, burada kelimeler
sonuç tercümeden geliyor, þimdi onun kelimelerini almaya baþlýyoruz ve
etikette bahsettiðimiz þekilde kaydýrýlan kelimelere tekabül edecek þekilde
eðitime devam ediyoruz, ve saða en sona gelince bir eðitim noktasý ile
iþimiz bitiyor.
...
uygulamalarýnda bu yaklaþým külfetli olabilir, burada performansý
iyileþtirebilecek bazý yaklaþýmlar var.
...
kelimeyi örnekleme yaparak alacaðýz). Sonra bu üretilen kelimeyi alýp
alttan YSA'ya artýk kod çözücüde tabii beslemeye devam edeceðiz, mesela Go
sonucu ``içeri'' kelimesi verilmiþ, biz ``içeri'' kelimesini alttan ikinci
RNN öðesine vereceðiz, bu bize üstten ``girmesine'' kelimesini
üretebilecek, böyle devam edecek. 
...
için yeterli görülmüyor, kod çözücü bloðundaki RNN öðeleri kaynak cümledeki
tüm kelimelere bir dikkat etme vektörü üzerinden baðlantýlý. Detaylar
[2]'de bulunabilir.
