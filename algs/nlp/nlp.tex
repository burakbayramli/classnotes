...
sýnýrlý sayýda kelimeyi alýrýz, mesela ilk 5'ý, yani her dokümanýn ilk 5
...
büyük gömme referans matrisi elde edilir. Bu referans matrisin baþlangýç
deðerleri rasgeledir. O zaman bu örnek YSA içinde bulunan gömme girdi
...
tabakalarý gibi de deðil; Her eðitim veri noktasý için indis bazlý esas
...
var, üstteki {\em Lineer Cebir} yazýsýnda komþu kelimeler tahmin edilmeye
...
içeriyor. Bu bir doðal dil iþleme ikisel sýnýflama problemi. Veriye
bakalým,
...
(preprocessing) aþamasýnda veriden yeni veri çýkartarak yapýlýrdý (tüm
ikili, üçlü kombinasyonlara bakarak), DYSA ile elimizde daha kullanýþlý bir
silah var. Evriþim.
...
ediliyor, bu vektörler üzerine max-pool iþlemi uygulanýyor, ve oradan gelen
sonuçlar softmax'e veriliyor.
