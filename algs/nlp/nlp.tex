...
amacýyla vektörün düzleþtirildiðini düþünelim,
...
Gomme Temsilinin Transferi

Ya kelimelerin komþuyla olan iliþkisi, ya da bozarak, ya da baþka þekilde
etiket elde edip eðittiðimiz gömülü referans matrisýndeki aðýrlýklarýn
anlamsal bir önemi olduðunu söylemiþtik. O zaman, eðer yeterince büyük bir
sözlük, etiketli veri ile eðitince elde ettiðimiz gömme aðýrlýklarýnýn bir
uygulamadan alýnýp bir diðerinde de kullanýlabilmesi gerekir, deðil mi? Bu
sorunun cevabý evet. Gömme aðýrlýklarýný transfer etmek hakikaten mümkün,
ve bunu yapan pek çok kiþi var.  
