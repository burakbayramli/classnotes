...
\begin{document}
Dışbükeylik, Noktaları Çevreleyen Bölgeler, Dışbükey Zarf (Convex Hull)
...
Sargilanan Sayi Algoritmasi (Winding Number Algoritm)
...
Sargılanan sayı algoritması bunu temel alıyor. Surada [6] bahsediliyor,
ornek kod alttadir,
...
[5] Bayramli, {\em Çok Değişkenli Calculus, Ders 3}
