...
Disaridan Okunan Veriyi Cizite Vermek
...
veri yok, sadece onlara dýþarýdan verdiðimiz veriyi dýþarý veriyorlar, yani
çizitin akýþýna dahil ediyorlar. Eðer onlara dýþarýdan veri verilmezse bir
hata mesajý görüyoruz.

Yer tutucularý tanýmlarken onlarýn önceden tipini tanýmlayabiliriz, þart
olmasa da bir büyüklük te tanýmlanabilir, fakat \verb!Nöne! ile burayý boþ
...
verisini ufak toptan parçalar olarak $X,y$ baðlamýnda çizite vermek için
kullanýlýr.
...
TensorFlow ile Cok Katmanli Yapay Sinir Aglari (Neural Network -NN-)
...
yaklaþýk olarak temsil edebilir, öðrenebilir. Düz lineer regeresyon ile
...
ReLu), buradan çýkan sonuç bir sonraki katmana aktarýlacak. Lineer
regresyon tek katmanlý ve aktivasyonu olmayan bir NN gibi de görülebilir.
...
baþta bu deðerler rasgele olarak seçildi, fakat bu aða bir veri versek,
bize bir hesap yapacaktýr,
...
Bu sayý çok büyük, fakat NN'i eðitim verisiyle eðitirken aðýrlýklar gerçek
hallerine yaklaþacaklar, o zaman üstteki gibi bir veri noktasý için daha
iyi bir sonuç 

Þimdi veriyi 80/20 oranýnda eðitim / doðrulama olarak ayýrýrýz, ve eðitim
veri seti üzerinde eðitim yaparýz. Nasýl? Eðitim verisinden
\verb!batch_size! büyüklüðünde mini toptan parçalar (minibatch)
örnekleyeceðiz, ve her eðitim döngüsünde optimize ediciye bu parçalarý
vereceðiz. 
...
istiyoruz. Ýlk akla gelebilecek en kolay çözüm bir önceki NN'i alýp oradan
gelecek tahminleri eþik deðeri 2.5 üstünde mi altýnda mý diye ek bir
filtrelemden geçirmek, yani regresyon sonucunu 0/1 tahminine çevirmek.  Bu
yaklaþým yüzde 55 civarý baþarý veriyor. 

Daha iyisi farklý bir NN'i özellikle 0/1 hedefi için eðitmek.
