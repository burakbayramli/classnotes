...
NN katmanlarýný hazýrlayalým [3], üç katman olacak, katmanlarda sýrasýyla 25,
10 ve 3 tane nöron olacak. Kayýp (loss) fonksiyonu L1 (mutlak deðer)
üzerinden hesaplanýyor. Optimize edici olarak TF'te \verb!AdamOptimizer!
adlý optimize ediciyi kullanacaðýz. 
...
Görüldüðü gibi eðitim ve test kayýbý birbirine yakýn ki bu iyiye iþaret,
model iyi öðreniyor, eksik uyum, aþýrý uyum durumlarý yok demektir, ve
nihai kayýp her iki tarafta da 0.7 kg civarý. 

Çift Kategori Sýnýflamasý

Peki istatistikte lojistik regresyon ile yaptýðýmýzý çok katmanlý NN ile
nasýl yaparýz? Mesela bebeðin 2.5 kg altýnda doðup doðmamasý diyelim, bu
bir riskli durum, ve direk bu hedef deðiþkeni için 0/1 tarzýnda bir eðitim
yapmak istiyoruz. Bir önceki NN'i alýp her yeni veri noktasý için kg
bazýnda tahmin üretip, bu tahmini eþik deðeri 2.5 üstünde mi altýnda mý
hesabýný yapabilirdik, bu hesap yüzde 55 civarý baþarý veriyor. Daha iyisi
baþka bir NN'i direk 0/1 hedefi için eðitmek. 
