...
#birth_file_text = open("lowbwt.dat").read()
#birth_data = birth_file_text.split('\r\n')[5:]
...
train_indices = np.random.choice(len(x_vals), np.round(len(x_vals)*0.8), replace=False)
