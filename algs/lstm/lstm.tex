...
olabiliyordu. RNN dýþ dünya hakkýndaki iç modelini güncelliyordu.

Fakat RNN ile tarif edilen bu güncellemeye hiç bir sýnýr getirmedik. Biraz
düþünürsek bu güncellemenin biraz kaotik bir hal alabileceðini
görebiliriz [1]. Mesela bir filmi kare kare izleyerek filmde neler olduðunu
tarif etmeye uðraþan bir RNN düþünelim. Bir karede bir karakterin ABD'de
olduðunu düþünebilir, ama sonraki karede karakterin susi yediðini görüyor
ve Japonya'da olduðuna karar veriyor, sonra Panda ayýsý görüyor ve onlarý
