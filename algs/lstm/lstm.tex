...
Kendini tekrarlayan YSA (RNN) yapýlarýnýn içindeki gizli konum $h_t$ (o
yazýda $s_t$ adý verilmiþti) olarak bir zaman diliminden bir diðerine
...
``hafýza'' olarak ta görülebilecek $h_t$'ye etkisi olabiliyordu. RNN dýþ
...
Trabzonspor'un hep kötüyü gittiðini, hep yanlýþ tranferler yaptýðýný
anlatan bir haber okuyoruz, ama bu haberi fenerbahçe.org sitesinde
...
Kuþbakýþý ile tüm resmi görelim, kendini tekrar eden LSTM yapýsý þuna
benzer,
...
sigmoid tabakasý tarafýndan kararlaþtýrýlýyor, bu tabaka $h_{t-1}$ ve
$x_t$'ye bakýyor ve $C_{t-1}$ hücre konumundaki her deðer için 0 ile 1
arasýnda bir sayý üretiyor. 1 bu deðeri tamamen tut, 0 bu deðeri tamamen
unut anlamýna geliyor (tüm $b$ deðerleri yanlýlýk -bias- için).
...
\includegraphics[width=30em]{lstm_06.png}
...
\includegraphics[width=30em]{lstm_07.png}

Þimdi üstteki formülleri kullanarak TensorFlow ile sýfýrdan bir LSTM
kodlayalým. Amacýmýz daha RNN için gördüðümüz zaman serisini öðrenmek, 
...
[[ 3.71134228]
 ...
 [ 4.39857443]]
3.60413751202
Epoch   20 | mean squ error  3604.8
Epoch   40 | mean squ error  2134.7
Epoch   60 | mean squ error  1349.9
Epoch   80 | mean squ error  928.2
Epoch  100 | mean squ error  681.5
Epoch  120 | mean squ error  570.9
Epoch  140 | mean squ error  486.0
Epoch  160 | mean squ error  419.0
Epoch  180 | mean squ error  363.4
Epoch  200 | mean squ error  316.0
Epoch  220 | mean squ error  275.1
Epoch  240 | mean squ error  240.7
Epoch  260 | mean squ error  212.3
Epoch  280 | mean squ error  189.4
Epoch  300 | mean squ error  171.2
Epoch  320 | mean squ error  156.5
Epoch  340 | mean squ error  143.9
Epoch  360 | mean squ error  132.4
Epoch  380 | mean squ error  121.4
Epoch  400 | mean squ error  111.1
Epoch  420 | mean squ error  101.6
Epoch  440 | mean squ error  93.0
Epoch  460 | mean squ error  85.5
Epoch  480 | mean squ error  78.9
Epoch  500 | mean squ error  73.2
\end{verbatim}

Tahminleri üretirken test verisinin en sonundaki 5 öðeyi alýp sonraki 1
deðeri üretiyoruz, bu deðeri tahmin için kullanýlan önceki verinin sonuna
ekliyoruz, eklenmiþ veriden tekrar bir 5 öðe alýyoruz (biraz önceki
tahminle beraber), yeni tahmin üretiyoruz, böyle gidiyor, ve bu þekilde
serinin hiç görmediðimiz kýsmýný tahmin ediyoruz.
...
mýkroelektronik yarý-iletken üretiminden gelen bir veri, fabrikasyon
sýrasýnda algýlayýcýlar bu iki turlu seriyi kaydediyor, onlarý ayýrtetmek
