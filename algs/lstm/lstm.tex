...
karakter o sahnede olmuþse, bunu hatýrlýyoruz. Yani modelin ne zaman
hatýrlayacaðýný, ne zaman unutacaðýný öðrenmesini istiyoruz. 

2) Bellege yazma (zulaya atma?) mekanizmasý. Model yeni bir kare gördüðünde
...
istiyoruz. Bize gereken bir tur hatirlama gecidi (remember gate), bu
elektronik devrelerdeki gibi bir gecit, 0 ile 1 arasinda olacak $n$ tane
sayi, bu sayi $n$ hafiza ogesinin ne kadar hatirlanacagini, yani ne kadar
uzun-vadeli olup olmayacagini belirleyecek. 1 tut, 0 unut demek olacak.

Dogal olarak ufak bir YSA kullanarak bir gecidi ogrenebiliriz, 
