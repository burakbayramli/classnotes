...
Şimdi ``sıfırıncı anda'' yani ilk başlangıçta uygulanan kuvveti hesaplamak
lazım. Noktayı üstte seçtik, sonu o noktada başlangıcı nesne ağırlık merkezinde
olan bir vektör ile kuvvet vektörü arasında çapraz çarpım yapıyoruz, bu bize
torku veriyor. 
...
lineer kuvvet bu doğrultuda uygulanacak, o vektör üzerine üstte görülen kırmızı
vektörü yansıtıyoruz, bu da lineer kuvvet oluyor.

Daha once soyledigimiz gibi her iki kuvvet de ilk anda lineer ve acisal
momentumu ekileyen faktorler. Sonraki adimlarda etkileri yok.
...
Bunlar problem değil, [5]'te bu tür bir kodlamayı görmüştük.
...
Animasyon sonucu [6]'da görülebilir.
...
[5] Bayramli, {\em Fizik, Simulasyon}

[6] Bayramli, {\em Animasyon 2},
