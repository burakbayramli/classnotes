...
olmasýný istemiyoruz. Sýnýr þartlarý $\underbar{x} =
...
Yazýnýn geri kalanýnda $\underbar{x}$, vs. kullanýlmayacak, çerçeveden
...
Optimal $u^*$'yu bulmak için $\frac{\partial \mathcal{H}}{\partial u}$ denklemini kullanýyoruz,
