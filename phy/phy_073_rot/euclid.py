...
#    
#def _intersect_line3_sphere_XX(L, S):
#    a = L.v.magnitude_squared()
...
class Point3(Vector3, Geometry):
    ...
    def distance(self, other):
        ...
        return 0.0
    # svo
    def is_close(self, other, tol=1.0e-6):
        return math.isclose(self.x, other.x, rel_tol=tol) \
               and math.isclose(self.y, other.y, rel_tol=tol) \
               and math.isclose(self.z, other.z, rel_tol=tol)
#
class Line3:
    __slots__ = ['p', 'v']
...
#
#
#s = Sphere(Point3(1.0, 2.0, 3.0), 0.5)
