...
uygulanan yönlerden de hesaplamak istiyoruz. Önce makaskiriş (truss) mekanığı
ile başlayalım. Makaskiriş konusuna [5]'te değinilmişti. 

Daha önce [1]'de gördüğümüz formülü hatırlarsak,
...
Makaskiriş öğelerinin sadece eksenel yüklenebildiklerini biliyoruz, eğer
alttaki gibi bir senaryo olsaydı, alt uçtan $q'_N$ kuvveti uygulanmış,
diğer nokta bir pime bağlı, bu durumda üstteki formülü değiştirip

$$
\Delta = \frac{NL}{AE} \to \frac{\Delta AE}{L} = N
$$

ve $\Delta$ yerine yer değişim $d_N$, kuvvet $N$ için $q'_N$ kullanarak
...
\includegraphics[width=10em]{phy_020_strs_05_06.jpg}

\includegraphics[width=10em]{phy_020_strs_05_07.jpg}

\includegraphics[width=10em]{phy_020_strs_05_08.jpg}
