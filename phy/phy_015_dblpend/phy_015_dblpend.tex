...
Bu sistemi þurada þu kuvvet, artý þurada þu kuvvet, þurada hareket þeklinde
modelleyebilirdik, fakat daha kolay bir yöntem sistemin Lagrangian'inini
hesaplamak ve onun optimalliði üzerinden Euler-Lagrange denklemlerini
kullanýp sistemýn formüllerinin burada dökülmesini saðlamak. 
...
Böylece dört yeni diferansiyel denklem yarattýk. (3), (4) denklemlerinde
...
Bu ODE sistemini sayýsal olarak çözebiliriz. Baþlangýç açýlarýný
$\theta_1,\theta_2$ için $\pi/4$ olarak seçtik, sarkaç sað taraftan
baþlayacak, ve sallanacak. 
...
Sistemin belli anlarda ``fotoðrafýný çekip'' grafikledik, ve bu grafikleri
animasyon olarak birleþtirirsek,

\begin{minted}[fontsize=\footnotesize]{python}
! convert -loop 0 -delay 100 frames/*.png frames/dblpend.gif
\end{minted}

Sonuçlarý [2]'de bulabiliriz. 
