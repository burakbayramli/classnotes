...
bulunmasý deneme / yanýlma ile olabilir (ayar -tune- safhasý bu demektir).

Genel olarak kontrol edilen parametre ve hedef deðiþken arasýnda
genelgeçer, yapay denebilecek bir iliþki kurulduðu söylenebilir. Sabitleri
ayarlayarak herhangi bir sistem için bu iliþkinin iþlemesini saðlýyoruz,
fakat formülsel olarak elimizde bir iliþki yok. ``Hata'' büyüklüðüne, onun
birkaç formuna bakarak, bunlara oranla bir kontrol uygulamak PÝD
yaklaþýmýnýn özü. Pratikte iyi iþliyor.
