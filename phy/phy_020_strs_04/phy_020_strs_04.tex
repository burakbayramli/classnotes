...
Devam edelim, $x$ ile başlayalım, o yöndeki denge için o yöndeki tüm kuvvetleri
toplamak gerekir, artı yüzdeki kuvveti pozitif yapacağız (bunu hatırlaması
kolay), tersini gösteren kuvvet ise negatif olacak, $X$ gövdeye uygulanan
dış kuvvettir ve birim hacim için verilmiştir, o zaman tüm toplam

$$
\sigma_x^+ \ud y \ud z - \sigma_x \ud y \ud z +
\tau_{yx}^+ \ud x \ud z - \tau_{yx} \ud x \ud z +
\tau_{zx}^+ \ud x \ud y - \tau_{zx} \ud x \ud y +
X \ud x \ud y \ud z = 0
$$
