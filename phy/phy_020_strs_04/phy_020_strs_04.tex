...
bakalım, bir tarafta $\epsilon$ gerilme matrisi diğer tarafta $\sigma$ stres
matrisi. İkisi arasında nasıl gidip gelinir? Burada bir Genelleştirilmiş Hooke
(Generalized Hooke) Kanunu geliştirmek mümkün. Öğeleri $\sigma_{ij}$ ve
$\sigma_{ij}$ olan stres ve gerilme tensörü arasıdaki ilişki
...
çevirmenin bir yolu 3 x 3 x 3 x 3 boyutundaki bir tensördür, en azından tensör
her $\sigma_{ij}$ öğesini diğerlerinden ayrı bir şekilde çarpıp toplamanın bir
yoludur.
