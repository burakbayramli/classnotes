...
Uzaklasim Teorisi ile esitligin sagindaki yuzey entegrali bir hacim entegraline
cevirilebilir. Ayrica esitligin solundaki turev ve entegral sirasi arasinda
degis tokus olabilir,
...
yolu entegrali alınan şeyin sıfır olmasıdır. Bir çelişki ile ispat argümanı da
kullanırsak, eğer entegralin alınan ifadenin sıfır olmadığı bir yer olsaydı,
hacmi onun etrafına odaklayarak üstteki eşitliğe ters düşebilirdik. O zaman
