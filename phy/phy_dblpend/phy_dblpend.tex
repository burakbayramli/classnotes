...
En basit formunda çifte sarkaç $l$ uzunluðunda kütlesiz iki çubuk, iki $m$
kütlesindeki topu birleþtirir, yani $m_1=m_2=m$, ve sallandýrýr. Eðer
$m_1$'in olduðu kordinatlarý $x_1,y_1$, $m_2$ kütlesini $x_2,y_2$ ile
belirtirsek,
...
Mesela $y_1$ için $- \ell \cos\theta_1$ olmasýnýn sebebi kordinat
bakýmýndan aþaðý doðru gidiyor olmamýz. 

Sistemin Lagrangian'ini hesaplayacaðýz, $L = T - V$. 

Kinetik enerji $T$ hesabini $\frac{1}{2} m v^2$ üzerinden yapabiliriz, ve
...
Açmak için $\dot{x}_1^2$, vs bulunmalý, üstteki $x_1$'in $t$ üzerinden
türevini almak lazým yani, mesela 
...
Devam edecek. $\dot{x}_2^2,\dot{y}_2^2$ benzer þekilde açýlýnca,
...
Potansiyel enerjiye gelelim, tek sarkactan $m g h$ formulu en yuksek
noktada en fazla potansiyel enerji verir. Bir kordinat sisteminde kutle
\#1'in sabitlendigi noktaya orijin dedik, o zaman en alt noktada, yani $2
\ell$'de enerji en azdir. Fakat $\ell$ negatif, pozitifsel durumu bunlari
idare eder zaten, biz direk formulu yazarsak, 

$$
V = m g y_1 + m g y_2
$$

Sadece dikey kordinat kullanildi cunku potansiyel enerji uzerinde tek
etkili olan dikey kordinattir. 

$$
= -m g \ell (2 \cos \theta_1 + \cos \theta_2)
$$

Tum sistem icin Lagrangian
