...
denklem $\dot{x} = Ax(t) + Bu(t)$ yeterli.

Sistemimizi lineerize etmemiz lazým. Bunu kritik nokta yakýnýnda
yapabiliriz, o zaman LQR adlý bir teknik sistemin o noktada kalmasý için
gerekli kontrol $F$ etkisini hesaplayabiliyor.
...
Örneðe dönelim; matrisimizin Jacobian'inin kritik nokta $(0,0,0,0)$'daki
deðerini bulabiliriz. Tüm bu iþlemler de \verb!sympy! ile yapýlabilir. Önce
$x$ üzerinden Jacobian,
