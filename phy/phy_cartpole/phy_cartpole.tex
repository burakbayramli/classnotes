...
denklem $\dot{x} = Ax(t) + Bu(t)$ yeterli. Lineerizasyonu kritik nokta
yakýnýnda yapacagiz, o zaman LQR adlý bir teknik sistemin o noktada kalmasý
için gerekli kontrol $F$ etkisini hesaplayabiliyor.
