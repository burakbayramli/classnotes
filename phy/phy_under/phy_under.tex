...
Lagrange yontemine gelelim; eger 

$$
\min_x J(x), \quad \textrm{ öyle ki } x(1) + x(2) = 3
$$

optimizasyonunu yapmak istiyorsam, Lagrange saðolsun, çözüm iki üstteki
problemi çözmek kadar kolay. Tek yapmamýz gereken geniþletilmiþ yeni bir
fonksiyon yaratmak,

$$
\tilde{J}(x)  = J(x) + \lambda [ x(1) + x(2) - 3 ]
$$
...
$$
\min_{x,\lambda} \partial \tilde{J} = 
\frac{\partial \tilde{J}}{\partial \lambda} = x(1) + x(2) - 3 = 0
$$

Üsttekinden gelecek çözüm kýsýtlamayý da dikkate alan bir çözüm olacaktýr. 

Cift Entegre Edici, Sayisal Cozum
