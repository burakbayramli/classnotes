...
\left[
\begin{array}{rrr}
l_2 c_{1+2} (\dot{\theta_1}+ \dot{\theta}) \\
l_2 s_{1+2} (\dot{\theta_1}+ \dot{\theta})
\end{array}
\right]
$$
...
$$
(I_1 + I_2 + m_2 l_1^2 + 2m_2 l_1 l_{c2} c_2) \ddot{q_1} + (I_2 + m_2
l_1 l_{c2} c_2)\ddot{q_2} - 2m_2 l_1 l_{c2} s_2 \dot{q_1} \dot{q_2}
$$

$$
-m_2 l_1 l_{c2} s_2 \dot{q_2}^2 + m_1 g l_{c1}s_1 + m_2 g
        (l_1 s_1 + l_{c2} s_{1+2}) = 0
$$

$$
(I_2 + m_2 l_1 l_{c2} c_2) \ddot{q_1} + I_2 \ddot{q_2} + m_2 l_1
        l_{c2} s_2 \dot{q_1}^2 + m_2 g l_{c2} s_{1+2} = \tau
$$


$$
\frac{\ud }{\ud t} \frac{\partial L}{\partial \dot{q}} - \frac{\partial
  L}{\partial q} = Q
$$
