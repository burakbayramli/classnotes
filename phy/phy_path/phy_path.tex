...
Baþlangýç noktalarý $x_0 = 3.66, y_0/h = -1.86$ deðerlerini kullanarak 
...
Çünkü $\lambda(t)$ sadece $t$'nin bir fonksiyonu, $x,y,z$ uzerinden
alinan tum turevler sifir sonucunu veriyor. Ayrica sifir vektorle
capraz carpim sifir vektordur, o zaman 
...
Benzer sekilde $(w \cdot \nabla) \lambda$ yine $\lambda$ uzerinde
$x,y,z$ kismi turev demektir, bu ifade de sifirdir,
