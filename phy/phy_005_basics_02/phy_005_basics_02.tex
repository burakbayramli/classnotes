...
bir sonraki nokta yine daireye o noktada teğet olan bir hız vektörüne dönüşüyor,
...
Kuvveti hesaplamak için vektörel ivmeyi hesaplayabiliriz. $v_i,v_f$ vektörel
farkı üstteki ikinci resimde gösteriliyor, iki vektörü dipleri biraraya gelecek
şekilde tekrar resimlendirirsek, $\Delta v = v_i - v_f$ olarak gözüküyor.  Bu
vektörel farktır. İvme için bu farkı $\Delta t$ ile böleriz, yani iki vektörün
arasındaki zaman farkına.
...
Aynı resimde sağda kenarları $\Delta v$ ve $v$ olan bir diğer üçgen var.
Aslında bu iki üçgen benzer üçgenlerdir, aynı $\theta$ açısına sahiplerdir.
İspat için alttaki resme bakalım,
...
Bu denklemi $\Delta v$ için yeniden düzenlersek, $\Delta v = v \Delta r / r$ olur,
ve onu (2) formülüne sokarsak,

$$
a = \frac{v \Delta v}{r \Delta t}
$$

elde ederiz. Şimdi $\Delta t \to 0$ durumunu düşünelim, yani bakılan aralık
küçülecek, o zaman $\Delta r / \Delta v$ oranının hız $v$'ye yaklaşmasını
bekleriz, $\lim_{\Delta t \to 0} \Delta r / \Delta v = v$.
