...
Peki üstteki formülden $\vec{v}$'yi geri elde etmek mümkün mü?
...
Sağ taraf üzerinde ``BAC-CAB açımi'' denen tekniği uygulayabiliriz, hatırlarsak,
lineer cebirde

$$
A \times (B \times C) = B(A \dot C) - C(A \times B)
$$
