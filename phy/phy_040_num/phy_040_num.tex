...
ki biz $p = 0.1$ seçeceðiz, ve konum deðiþkeni $x(t)$ $t$ anýndaki elektrik
akýmý $I$'yý temsil ediyor. ODE sistemini çýkartmak için $x_1 = x$,
$x_2 = \dot{x}$ dersek,
...
t$ formulunden biraz farklý, $\phi$ yok, yani varýlan son konum için bir
bedel tanýmlanmadý. Bunun sonucu $\lambda(t_f)$'in sýfýr olmasýdýr.
...
formülü verilmiþti. $f$ formülü üstte görülen $\dot{x}_1$ ve
$\dot{x}_2$'den oluþuyor tabii.
...
Son grafikte optimal kontrol politikasýný görüyoruz. 
