...
$$ P(E|F) $$
%{{_preview/f-1100802904.png}}

olarak gösterilir. Bu formülün açýlýmý

$$ P(E|F) = \frac{P(EF)}{P(F)}
\mlabel{1}$$
%{{_preview/f-74460321.png}}
...
$$ P(EF) = P(E)P(F) $$
%{{_preview/f--420100170.png}}

ise. (1) denklemi üzerinden bu

$$ P(E|F) = P(E) $$
%{{_preview/f--694430260.png}}
...
$$ P(E) = P(EF) + P(EF^c) $$
%{{_preview/f-1104769905.png}}

$$ = P(E|F)P(F) + P(E|F^c)P(F^c) $$
%{{_preview/f--685457247.png}}

$$ = P(E|F)P(F) + P(E|F^c)(1-P(F)) $$
%{{_preview/f--936748043.png}}
...
\mlabel{2}
$$
%{{_preview/f--1534267988.png}}

$$
\frac{(0.95)(0.005)}
{(0.95)(0.005) + (0.01)(0.995)} $$
%{{_preview/f--370093945.png}}

$$ = \frac{95}{294} \approx 0.323 $$
%{{_preview/f-1225967020.png}}
...
$$ p_X(x|y) = P(X=x|Y=y) $$
%{{_preview/f--441693276.png}}

$$ = \frac{P(X=x,Y=y)}{P(Y=y)} $$
%{{_preview/f-125260387.png}}

$$ = \frac{p(x,y)}{p_Y(y)} $$
%{{_preview/f--1415018502.png}}
...
$$ p_X(x|y) = P(X=x|Y=y)  $$
%{{_preview/f-1200088177.png}}

$$ = P(X=x) $$
%{{_preview/f--1663323705.png}}
...
%{{_preview/f-1204281133.png}}

$$  = \sum_y \bigg( \sum _x x \cdot P(X=x|Y=y) \bigg) P(Y=y) $$
%{{_preview/f--1690627875.png}}

$$  = \sum_y  \sum _x x \cdot P(X=x|Y=y) P(Y=y) $$
%{{_preview/f--439406741.png}}

$$  = \sum_x x \sum _y P(X=x|Y=y) P(Y=y) $$
%{{_preview/f--216561234.png}}

$$  = \sum_x x \sum _y P(X=x,Y=y) $$
%{{_preview/f-1578946411.png}}

$$  = \sum_y x  P(X=x) $$
%{{_preview/f-1675867043.png}}

$$ = E(X) $$
%{{_preview/f--1561081201.png}}
...
$$
%{{_preview/f--2008711466.png}}

$$
E(X) = \frac{1}{3} \big( E(X | Y=1)  + E(X | Y=2) +E(X | Y=3) \big)
\mlabel{3}
$$
%{{_preview/f--1663032440.png}}
...
$$ E(X|Y=1) = 2$$
%{{_preview/f-1791729829.png}}

$$ E(X|Y=2) = 3 + E(X) $$
%{{_preview/f--134633496.png}}

$$ E(X|Y=3) = 5 + E(X) $$
%{{_preview/f--1858707511.png}}
...
$$
%{{_preview/f--266485089.png}}

$$ E(X) = 10 $$
%{{_preview/f-901030317.png}}
