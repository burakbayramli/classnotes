...
geçerek (öne pass) hem sayýsal ortalamayý hem de sayýsal varyansý
...
et, ondan sonra kovaryanslarýný al. 

Niye kovaryans içeren ifadeyi tercih ediyoruz? Çünkü, diyelim ki $X,Y$
deðiþkenleri bir uzaklýk ölçüsünü temsil ediyor, ve birimleri mesela
nanometre. Fakat bir baþkasý gelip ayný ölçümü, atýyorum, ýþýk yýlý olarak
kullanmaya baþlarsa problem çýkabilir. Yani eðer birim yoksa ve ben ``$X,Y$
korelasyonum 42'' dersem, bunun ne olduðunu anlamak zordur. 42 önümüzdeki
veriye göre küçük müdür, büyük müdür? Bilemeyiz. Yani 42 sayýsý tabii ki
evrendeki tüm sorularýn cevabýdýr [hoca bir filme atfen espri yapýyor,
orada 42 sayýsýnýn özel bir anlamý vardý], ama önümüzdeki problem için,
nedir? 
