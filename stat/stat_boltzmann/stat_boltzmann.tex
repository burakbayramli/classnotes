...
Gibbs örneklemesinin detaylarý için {\em Monte Carlo, Entegraller, MCMC}
yazýsýna danýþýlabilir. Bölzmann daðýlýmýndan örneklem almak için bize tek
bir deðiþken (hücre) haricinde diðer hepsinin bilindiði durumun olasýlýk
hesabý lazým, yani koþulsal olasýlýk $P(x_i = 1 | x_j, j \ne i)$. Yani $x$
üzerinde, biri hariç tüm öðelerin bilindiði durumda bilinmeyen tek hücre
$i$'nin 1 olma olasýlýk deðeri,
...
fonksiyonlar hakkýnda daha fazla bilgi {\em Lojistik Regresyon} yazýsýnda
bulunabilir.
