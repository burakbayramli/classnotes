...
bizim seçtiðimiz baz fonksiyondur. RBF'in turevi nedir? Analitik olarak
hesaplayabiliriz,
...
Dikkat $\,r_j=\|w_j\|\,$ ogelerinin kendisi $\,r\in{\mathbb R}^m$
vektorunun ayni zamanda ogesi.  Kartezyen baz vektorleri The cartesian base vector
$\,e_k\in{\mathbb R}^m$ usttekini 
...
ile yazabiliriz, ki $\odot$ ogesel bazli Hadamard carpimidir.

Ayrica vektorler kosegen matrisler arasinda gecis yapabilmek faydalidir, ki
bu matrisleri buyuk harfle belirtecegiz, mesela
...
$i^{th}$ bileseni kontrol edersek (1) formulunu ortaya cikartabilecegimizi
goruyoruz, demek ki dogru yoldayiz,
...
Ýki nokta üst üste iz (trace) için Frobenius çarpým notasyonudur
