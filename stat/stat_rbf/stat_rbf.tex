...
Burada RBF ile aslýnda analýk bir fonksiyon yaratmýþ olduk. Bir kez
...
\begin{minted}[fontsize=\footnotesize]{python}
x_test = 36.16; y_test = 32.77
w1 = 0.5; w2 = 0.5

d1 = (x_test-xm[0])**2 + (y_test-ym[0])**2
d2 = (x_test-xm[1])**2 + (y_test-ym[1])**2
