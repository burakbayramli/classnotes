...
deðiþkenin deðerlerini o daðýlýmýn kumulatif daðýlým fonksiyonuna (cdf)
...
konusunun arkasýnda derin bir literatur var, baþlangýç olarak [2].
...
seçseydik, $Z_0=1$ ile $1,6,3,2,4,6$ yani kut diye 6'ya döndük. Bu olmadý, tam
...
sayýdan daha fazla sayý üretebilen bir üreteçtir. Kodu altta bulunabilir,
...
$$ 
\int _{0}^{1} h_j(y)^2 \ud y = 1 \mlabel{1}
$$
...
Trigonometrik esitlik [4, sf 435]
