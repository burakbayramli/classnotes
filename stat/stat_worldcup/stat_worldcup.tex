...
görebiliriz.. Adam ayný kitadan, belki o kýtaya alýþýk, iklimi vs ona
normal geliyor.. ? Olabilir mi? Diðer bazý modeller \verb!iþ_home!'u sadece
...
sübjektif.. Biz \verb!iþ_home! öðesine 0.0 ila 1.0 arasýnda bir deðer
...
düþünce tarzý dahiyane bir yaklaþým. Örnek iþ kolumuzun, veri biliminin
ruhunu göstermesi bakýmýndan güzel bir örnek. Veri temsilinden tutun,
regresyonun kodlanmasýnda çeyrekliklere ayýrmak, az veri olduðu için
yaklaþýksallýk (convergence) olmayabilir diye deðiþik parametrelerle
regresyonu birkaç kez iþletmek, bunu yaklaþýksallýk olana kadar yapmak, tam
anlamýyla bir ders niteliði taþýyor. 
...
[4] Bayramlý, {\em Google ile Dunya Kupasi Tahmini}, \url{http://sayilarvekuramlar.blogspot.com/2014/07/dunya-kupasini-tahmin-lojistik-regresyon.html}
