...
lojistik regresyon gibi, bu $h$'ler ve etiketler üzerinden takip edilen bir
(supervised) eðitim yapabiliriz. Yani, önce RBM eðitiyoruz, tüm verinin $h$
karþýlýðýný alýyoruz, sonra bunlarý lojistik regresyona veriyoruz. Alttaki
kodda bunun örneðinin görebiliriz.
...
[5] Larochelle, H., {\em Neural networks [5.1] : Restricted Boltzmann machine - definition}, \url{https://www.youtube.com/watch?v=p4Vh_zMw-HQ}
