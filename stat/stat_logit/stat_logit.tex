...
kumulatif alansal hesaplarýn CDF üzerinden gerçekleþtirilebildiðini
hatýrlayalým.
...
bahsediliyor, ki bu konuyu {\em Lojistik Regresyon} yazýsýnda
bulabilirsiniz. Ama istatistik literatüründe (yapay öðrenim literatüründen
farklý olarak), terminoloji biraz kafa karýþtýrýcý olabiliyor. Lojistik
regresyon yazýsýnda odaðýmýz sigmoid fonksiyonuydu, peki logit nereden geliyor?
Logit,
...
\verb!majorçards! = Büyük kredi kart þirketlerinden kaç tane kartý var

\verb!active! = Kaç tane aktif kredi kart hesabý var

\verb!expenditüre! = Aylýk kredi kartý harcamasý
...
\includegraphics[height=9cm]{stat_logit_01.png}
...
[2] Vogel, {\em Logistic models of well switching in Bangladesh}, \url{http://nbviewer.ipython.org/urls/raw.github.com/carljv/Will_it_Python/master/ARM/ch5/arsenic_wells_switching.ipynb}

[3] {\em A Weakly Informative Default Prior Distribution for Logistic and Other Regression models}, \url{http://www.stat.columbia.edu/~gelman/research/published/priors11.pdf}
