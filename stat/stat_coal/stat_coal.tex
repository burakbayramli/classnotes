...
daðýlýmýna sahip olduðunu biliyoruz. O zaman, belki de ilk yapmamýz gereken bu
veriye iki tane Poisson uydurmak, yani veriyi iki Poisson daðýlýmýnýn karýþýmý
olarak temsil etmek. Karýþýmlar konusu {\em Çok Deðiþkenli Bernoulli Karýþýmý}
yazýsýnda görülebilir, buradaki tek fark Bernoulli yerine Poisson kullanýlacak
olmasý. Ýdeal olarak uydurma operasyonu için Beklenti-Maksimizasyon
(Expectation-Maximization -EM-) kullanýlýr. Fakat denklemleri türetmek zaman
alabilir, biz þuradaki tavsiyeyi [4, sf. 11] takip ederek bu örnek için
uydurmayý bir gayrý lineer optimizasyon paketi \verb!lmfit! ile yapacaðýz
(tavsiyenin R kodu \verb!coal.r! içinde).
