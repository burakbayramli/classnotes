...
Þimdi $(k/n)(1-k/n)$ çarpýmýný düþünelim. {\em Örneklem Büyüklüðü}
bölümünde gördük, $n$ her zaman $k$'den büyük olduðuna göre $k/n$ her zaman
0 ve 1 arasýndadýr, o zaman $(k/n)(1-k/n) \le 1/4$ olmalýdýr, yani
gösterilen çarpým 1/4'ten büyük olamaz. Bunu alýp üstteki formül içine
koyarsak,
...
Burada $\Phi$ standart Gaussian'ý temsil ediyor (detaylar için {\em Ýstatistik
  Ders 1}) ve CDF fonksiyonuna tekabül ediyor. CDF fonksiyonunun ayný zamanda
yüzdelik dilimi (quantile) hesapladýðý söylenir, aslýnda CDF son derece detaylý
bir olasýlýk deðeri verir fakat evet, dolaylý yoldan noktanýn hangi çeyrek içine
düþtüðü de görülecektir.
