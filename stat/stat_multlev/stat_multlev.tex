...
literatürü takýp edebiliriz, ama biz [1]'deki tavsiyeyi takip edip ``çok
...
memnun deðiliz, mesela gruplararasý deðiþkenlerin (between-sübject
covariates), yaþ gibi, standart hatalarý aþýrý ufak. Bunun sebebi regresyon
iþleminin tüm veri satýrlarýný baðýmsýz (ýndependent) kabul etmesidir, yani
...
\verb!(1+sübject)! kullanýmý gruplamayý kiþi bazýnda yapýyor ve her grup
...
[3] Bayramli, {\em iPython, rpy2, rmagic}, \url{http://sayilarvekuramlar.blogspot.de/2015/02/ipython-rpy2-rmagic.html}
